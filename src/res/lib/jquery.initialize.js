 ...
 */
;function jQueryInitializeFactory($, defaultDocument) {
    ...
    // Options
    $.initialize.defaults = {
        target: defaultDocument?.documentElement || document.documentElement, // Defaults to observe the entire document.
