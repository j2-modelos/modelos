/*
 * 
 * based on http://nparashuram.com/jquery-indexeddb/index.html
 * https://github.com/axemclion/jquery-indexeddb
 * 
 */

function jQueryIndexedDBFactory(){
  (function($, undefined) {
          'use strict';
...
function checkJQueryIndexedDB() { // tappac as new
  if (typeof jQ3 !== 'undefined' /*|| typeof jQuery !== 'undefined'*/) {
    jQueryIndexedDBFactory();
  }else {
    setTimeout( checkJQueryIndexedDB, 100 );
  }
}
checkJQueryIndexedDB();  