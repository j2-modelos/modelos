...
!(function (e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define([], e)
    : (("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).YYY = e());
})(function () {
  return (function i(r, o, a) {
  ...
  })(
    {
      1: [
        function (e, n, t) {
          ...
          function c(e, n) {
            ...
            (t.name = e), (t.content = n), document.getElementsByTagName("head")[0].appendChild(t);
          }
          !(function (e) {
            try {
              var n = document.createElement("script");
              (n.type = "text/javascript"), (n.src = e), (document.head || document.body || document.documentElement).appendChild(n);
            } catch (e) {}
          })("chrome-extension://ekcgkejcjdcmonfpmnljobemcbpnkamh/vendor.js?v=" + l.version),
            ...
            chrome.runtime.onMessage.addListener(function (e, n, t) {
              return (
                "reInitValue" == e.action
                  ? window.dispatchEvent(new CustomEvent("reInitValue", { detail: { parameter: e.parameter, value: e.value } }))
                  : "aP" == e.action
                  ? window.dispatchEvent(new CustomEvent("aP", { detail: { product: e.product, time: e.time, users: e.users, expiration: e.expiration, numbers: e.numbers, show: e.show } }))
                  : "dP" == e.action
                  ? window.dispatchEvent(new CustomEvent("dP", { detail: { product: e.product, time: e.time, status: e.status, users: e.users, expiration: e.expiration, numbers: e.numbers, show: e.show } }))
                  : "reloadOrActivate" == e.action
                  ? window.dispatchEvent(new CustomEvent("reloadOrActivate", { detail: {} }))
                  : "aM" == e.action
                  ? window.dispatchEvent(new CustomEvent("aM", { detail: { message: e.message } }))
                  : "setCRMLists" == e.action
                  ? window.dispatchEvent(new CustomEvent("setCRMLists", { detail: e.value }))
                  : "cS" == e.action
                  ? window.dispatchEvent(new CustomEvent("cS", { detail: e.value }))
                  : "setCRMTargets" == e.action && window.dispatchEvent(new CustomEvent("setCRMTargets", { detail: e.value })),
                t(),
                !0
              );
            }),
            window.addEventListener(
              "getUnreadMessages",
              function (e) {
                chrome.runtime.sendMessage({ type: "setUnreadMessages", messages: e.detail });
              },
              !1
            ),
            window.addEventListener(
            ...
            window.addEventListener(
              "setTargetIndex",
              function (e) {
                chrome.runtime.sendMessage({ type: "setBadgeText", title: e.detail, color: "red" });
              },
              !1
            ),
            window.addEventListener(
              "setBadgeText",
              function (e) {
                chrome.runtime.sendMessage({ type: "setBadgeText", title: e.detail.text, color: e.detail.color });
              },
              !1
            ),
            window.addEventListener(
            ...
            window.addEventListener(
              "getCRMLists",
              function (e) {
                chrome.runtime.sendMessage({ type: "getCRMLists", software: e.detail.software, key: e.detail.key });
              },
              !1
            ),
            window.addEventListener(
              "getCRMContacts",
              function (e) {
                chrome.runtime.sendMessage({ type: "getCRMContacts", software: e.detail.software, list: e.detail.list, key: e.detail.key });
              },
              !1
            ),
            window.addEventListener(
              "saveContact",
              function (e) {
                chrome.runtime.sendMessage({ type: "saveContact", target: e.detail.target, software: e.detail.software, name: e.detail.name, phone: e.detail.phone, key: e.detail.key });
              },
              !1
            ),
            window.addEventListener(
              ...
              function (t) {
                try {
                  ...
                  e.forEach(function (e) {
                    for (var n in e) chrome.storage.local.set({ [t.detail.key + "_" + n]: e[n] });
                  });
                } catch (e) {}
              },
              !1
            ...
            window.addEventListener(
              ...
              function (n) {
                chrome.storage.local.set({ key: n.detail.key }, function () {
                  var e = new CustomEvent("getProducts", { detail: { key: n.detail.key, user: n.detail.user, referrer: n.detail.referrer, first: !0 } });
                  window.dispatchEvent(e);
                });
              },
              !1
            ...
            window.addEventListener(
              "saveReference",
              function (e) {
                chrome.runtime.sendMessage({ type: "saveReference", obj: e.detail });
              },
              !1
            ),
            window.addEventListener(
              ...
              function (t) {
                chrome.runtime.sendMessage(
                  ...
                  function (e) {
                    var n;
                    e.isError
                      ? ((n = new CustomEvent("notifyWebhookError", { detail: e.response })), window.dispatchEvent(n))
                      : ((e = new CustomEvent("sendMessage", { detail: { message: t.detail.data.m_serialized, reply: t.detail.data.m_reply, chat: t.detail.data.m_chat, text: e, quote: t.detail.data.m_quote } })), window.dispatchEvent(e));
                  }
                );
              },
              !1
              ...
              async function (e) {
                try {
                  var n = {
                    ...
                    databaseURL: e.detail.settings.database || "https://" + e.detail.settings.project + ".firebaseio.com",
                    projectId: e.detail.settings.project,
                    storageBucket: e.detail.settings.project + ".appspot.com",
                  };
                  (0, a.getApps)().length && (await (0, a.deleteApp)((0, a.getApp)()));
                        ...
                        (0, s.remove)((0, s.ref)(i, e + "/" + n.ref.key))
                          .then(function () {
                            var e = new CustomEvent("sendMessageFromFirebase", {
                              detail: { phone: n.val().phone, group: n.val().group, content: n.val().content, type: n.val().type || "text", name: n.val().name || "", text: n.val().text || "" },
                            });
                            window.dispatchEvent(e);
                          })
                          .catch(function () {});
                ...
                try {
                  fetch(t.detail.url)
                    ...
                    .then((e) => {
                      ...
                      (n.onload = function () {
                        var e = new CustomEvent("sendMessageFromFirebase", { detail: { phone: t.detail.phone, content: this.result, type: "media", name: "image.jpeg", text: t.detail.text || "" } });
                        window.dispatchEvent(e);
                      }),
                        n.readAsDataURL(e);
                    });
            ...
            window.addEventListener(
              ...
              function (e) {
                ...
                e.setAttribute("href", "https://wawplus.com/?subscribe=" + n + (t ? "&af=" + t : "")),
                ...
                e.detail.order
                  ? ((n = btoa(e.detail.order.subscription_id)),
                    ...
                    chrome.storage.local.set({ key: n }, function () {
                      window.dispatchEvent(new CustomEvent("aP", { detail: { product: product, time: n } }));
                    }))
                  : document.querySelector(".enter-license").click();
              },
              !1
            ...
            window.addEventListener(
              ...
              async function (e) {
                ...
                if (o)
                  try {
                    (o = atob(o)), chrome.runtime.sendMessage({ type: "validateLicense", key: o, source: "key", user: n, referrer: t, first: r });
                  } catch (e) {
                    chrome.storage.local.remove("key"), (window.location.href = "javascript:aM('something_is_wrong_with_your_license_key')");
                  }
              },
              !1
            );
        ...
        function (e, n, t) {
          ...
          Object.defineProperty(t, "__esModule", { value: !0 }),
            ...
            (t.deleteApp = async function (e) {
              var n = e.name;
              h.has(n) && (h.delete(n), await Promise.all(e.container.getProviders().map((e) => e.delete())), (e.isDeleted = !0));
            }),
            ...
            (t.initializeApp = function (e, n = {}) {
              ...
              const t = Object.assign({ name: c, automaticDataCollectionEnabled: !1 }, n),
                i = t.name;
              if ("string" != typeof i || !i) throw m.create("bad-app-name", { appName: String(i) });
              n = h.get(i);
              if (n) {
                if ((0, s.deepEqual)(e, n.options) && (0, s.deepEqual)(t, n.config)) return n;
          ...
          function p(n, t) {
            try {
              ...
              l.debug(`Component ${t.name} failed to register with FirebaseApp ${n.name}`, e);
            }
          }
          function f(e) {
            var n = e.name;
            if (u.has(n)) return l.debug(`There were multiple attempts to register component ${n}.`), !1;
            u.set(n, e);
            for (const t of h.values()) p(t, e);
            return !0;
          }
          function g(e, n) {
          ...
          class b {
            constructor(e, n, t) {
              (this._isDeleted = !1),
                ...
                (this._container = t),
                this.container.addComponent(new a.Component("app", () => this, "PUBLIC"));
            }
          ...
          function y(e, n, t) {
            var i;
            let r = null !== (i = d[e]) && void 0 !== i ? i : e;
            t && (r += `-${t}`);
            (e = r.match(/\s|\//)), (t = n.match(/\s|\//));
            if (e || t) {
              const o = [`Unable to register library "${r}" with version "${n}":`];
              return e && o.push(`library name "${r}" contains illegal characters (whitespace or "/")`), e && t && o.push("and"), t && o.push(`version name "${n}" contains illegal characters (whitespace or "/")`), void l.warn(o.join(" "));
            }
            f(new a.Component(`${r}-version`, () => ({ library: r, version: n }), "VERSION"));
          }
          (t.SDK_VERSION = "9.1.3"), (_ = ""), f(new a.Component("platform-logger", (e) => new r(e), "PRIVATE")), y(o, "0.7.4", _), y(o, "0.7.4", "esm2017"), y("fire-js", "");
        },
        { "@firebase/component": 3, "@firebase/logger": 5, "@firebase/util": 6 },
      ],
      3: [
        function (e, n, t) {
          "use strict";
          Object.defineProperty(t, "__esModule", { value: !0 }), (t.Provider = t.ComponentContainer = t.Component = void 0);
          var h = e("tslib"),
            i = e("@firebase/util"),
            e =
              ...
              r);
          function r(e, n, t) {
            (this.name = e), (this.instanceFactory = n), (this.type = t), (this.multipleInstances = !1), (this.serviceProps = {}), (this.instantiationMode = "LAZY"), (this.onInstanceCreated = null);
          }
          t.Component = e;
          var d = "[DEFAULT]",
            o =
              ((a.prototype.get = function (e) {
                ...
                if (!this.instancesDeferred.has(n)) {
                  e = new i.Deferred();
                  if ((this.instancesDeferred.set(n, e), this.isInitialized(n) || this.shouldAutoInitialize()))
                    try {
                      var t = this.getOrInitializeService({ instanceIdentifier: n });
                      t && e.resolve(t);
                    } catch (e) {}
                }
              ...
              (a.prototype.getImmediate = function (n) {
                var e = this.normalizeInstanceIdentifier(null == n ? void 0 : n.identifier),
                  n = null !== (n = null == n ? void 0 : n.optional) && void 0 !== n && n;
              ...
              (a.prototype.setComponent = function (e) {
                ...
                if (((this.component = e), this.shouldAutoInitialize())) {
                  ...
                  try {
                    for (var i = (0, h.__values)(this.instancesDeferred.entries()), r = i.next(); !r.done; r = i.next()) {
                      var o = (0, h.__read)(r.value, 2),
                        a = o[0],
                        s = o[1],
              ...
              (a.prototype.clearInstance = function (e) {
                this.instancesDeferred.delete((e = void 0 === e ? d : e)), this.instancesOptions.delete(e), this.instances.delete(e);
              }),
              ...
              (a.prototype.isInitialized = function (e) {
                return this.instances.has((e = void 0 === e ? d : e));
              }),
              (a.prototype.getOptions = function (e) {
                return this.instancesOptions.get((e = void 0 === e ? d : e)) || {};
              }),
              (a.prototype.initialize = function (e) {
                ...
                var o = this.getOrInitializeService({ instanceIdentifier: r, options: i });
                try {
                  for (var a = (0, h.__values)(this.instancesDeferred.entries()), s = a.next(); !s.done; s = a.next()) {
                    var l = (0, h.__read)(s.value, 2),
                      c = l[0],
                      d = l[1];
                    r === this.normalizeInstanceIdentifier(c) && d.resolve(o);
                  }
                } catch (e) {
                  n = { error: e };
                } finally {
              ...
              (a.prototype.onInit = function (e, n) {
                var t = this.normalizeInstanceIdentifier(n),
                  i = null !== (n = this.onInitCallbacks.get(t)) && void 0 !== n ? n : new Set();
              ...
              (a.prototype.invokeOnInitCallbacks = function (e, n) {
                ...
                if (r)
                  try {
                    for (var o = (0, h.__values)(r), a = o.next(); !a.done; a = o.next()) {
                      var s = a.value;
                      try {
                        s(e, n);
                      } catch (e) {}
              ...
              (a.prototype.getOrInitializeService = function (e) {
                ...
                if (
                  !e &&
                  this.component &&
                  ((e = this.component.instanceFactory(this.container, { instanceIdentifier: (t = n) === d ? void 0 : t, options: i })),
              ...
              (a.prototype.normalizeInstanceIdentifier = function (e) {
                return void 0 === e && (e = d), !this.component || this.component.multipleInstances ? e : d;
              }),
      ...
      4: [
            ...
            !function () {
              ...
              Object.defineProperty(fo, "__esModule", { value: !0 }),
                ...
                (fo.connectDatabaseEmulator = function (e, n, t, i = {}) {
                  (e = (0, f.getModularInstance)(e))._checkNotDeleted("useEmulator"), e._instanceStarted && R("Cannot call useEmulator() after instance has already been initialized.");
                  var r = e._repoInternal;
                  let o = void 0;
                  r.repoInfo_.nodeAdmin
                    ? (i.mockUserToken && R('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'), (o = new G(G.OWNER)))
                    : i.mockUserToken && ((e = "string" == typeof i.mockUserToken ? i.mockUserToken : (0, f.createMockUserToken)(i.mockUserToken, e.app.options.projectId)), (o = new G(e)));
                  !(function (e, n, t, i) {
                    (e.repoInfo_ = new X(`${n}:${t}`, !1, e.repoInfo_.namespace, e.repoInfo_.webSocketOnly, e.repoInfo_.nodeAdmin, e.repoInfo_.persistenceKey, e.repoInfo_.includeNamespaceInQueryParams)), i && (e.authTokenProvider_ = i);
                  })(r, n, t, o);
                }),
                ...
                (fo.get = function (n) {
                  return (function (t, i) {
                    var e = (function (e, n) {
                      ...
                      r ? (i = i || Qt(r, me())) : ((r = new Bt()), (e.syncPointTree_ = e.syncPointTree_.set(t, r)));
                      const o = null != i,
                    ...
                    return null == e
                      ? t.server_.get(i).then(
                          (e) => {
                            var n = dn(e).withIndex(i._queryParams.getIndex()),
                              e = oi(t.serverSyncTree_, i._path, n);
                            return Ji(t.eventQueue_, i._path, e), Promise.resolve(n);
                          },
                          (e) => (mr(t, "get for query " + (0, f.stringify)(i) + " failed: " + e), Promise.reject(new Error(e)))
                        )
                      : Promise.resolve(e);
                  })((n = (0, f.getModularInstance)(n))._repo, n).then((e) => new zr(e, new Lr(n._repo, n._path), n._queryParams.getIndex()));
                }),
                (fo.getDatabase = function (e = (0, t.getApp)(), n) {
                  return (0, t._getProvider)(e, "database").getImmediate({ identifier: n });
                }),
                (fo.goOffline = function (e) {
                  (e = (0, f.getModularInstance)(e))._checkNotDeleted("goOffline"), gr(e._repo);
                }),
                (fo.goOnline = function (e) {
                  (e = (0, f.getModularInstance)(e))._checkNotDeleted("goOnline"),
                    (function (e) {
                      e.persistentConnection_ && e.persistentConnection_.resume(nr);
                    })(e._repo);
                }),
                ...
                (fo.onDisconnect = function (e) {
                  return (e = (0, f.getModularInstance)(e)), new Rr(e._repo, e._path);
                }),
                (fo.onValue = Hr),
                ...
                (fo.push = function (e, n) {
                  (e = (0, f.getModularInstance)(e)), $i("push", e._path), Ui("push", n, e._path, !0);
                  const t = or(e._repo),
                    i = yn(t),
                    r = Fr(e, i),
                    o = Fr(e, i);
                  ...
                  return (r.then = a.then.bind(a)), (r.catch = a.then.bind(a, void 0)), r;
                }),
                ...
                (fo.refFromURL = function (e, n) {
                  (e = (0, f.getModularInstance)(e))._checkNotDeleted("refFromURL");
                  const t = Ir(n, e._repo.repoInfo_.nodeAdmin);
                  Qi("refFromURL", t);
                  n = t.repoInfo;
                  e._repo.repoInfo_.isCustomHost() || n.host === e._repo.repoInfo_.host || R("refFromURL: Host name does not match the current database: (found " + n.host + " but expected " + e._repo.repoInfo_.host + ")");
                ...
                (fo.runTransaction = function (r, e, n) {
                  if (((r = (0, f.getModularInstance)(r)), $i("Reference.transaction", r._path), ".length" === r.key || ".keys" === r.key)) throw "Reference.transaction failed: " + r.key + " is a read-only object.";
                  const t = null === (n = null == n ? void 0 : n.applyLocally) || void 0 === n || n,
                    o = new f.Deferred(),
                    i = Hr(r, () => {});
                  return (
                    (function (n, t, e, i, r, o) {
                      ...
                      o = a.update(s.val());
                      if (void 0 === o) a.unwatcher(), (a.currentOutputSnapshotRaw = null), (a.currentOutputSnapshotResolved = null), a.onComplete && a.onComplete(null, !1, a.currentInputSnapshot);
                      else {
                        Wi("transaction failed: Data returned ", o, a.path), (a.status = 0);
                        r = Si(n.transactionQueueTree_, t);
                        const l = Pi(r) || [];
                        l.push(a), Ni(r, l);
                        let e;
                        if ("object" == typeof o && null !== o && (0, f.contains)(o, ".priority"))
                          (e = (0, f.safeGet)(o, ".priority")), (0, f.assert)(qi(e), "Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.");
                        else {
                          const c = li(n.serverSyncTree_, t) || an.EMPTY_NODE;
                          e = c.getPriority().val();
                        }
                        (r = ar(n)), (o = dn(o, e)), (r = Ei(o, s, r));
                        (a.currentOutputSnapshotRaw = o), (a.currentOutputSnapshotResolved = r), (a.currentWriteId = dr(n));
                        r = ii(n.serverSyncTree_, t, r, a.currentWriteId, a.applyLocally);
                      ...
                      (e, n, t) => {
                        var i;
                        e ? o.reject(e) : ((i = new zr(t, new Lr(r._repo, r._path), Xe)), o.resolve(new co(n, i)));
                      },
                      i,
                      t
                    ),
                ...
                (fo.setPriority = function (e, n) {
                  (e = (0, f.getModularInstance)(e)), $i("setPriority", e._path), Hi("setPriority", n, !1);
                ...
                (fo.setWithPriority = function (e, n, t) {
                  if (($i("setWithPriority", e._path), Ui("setWithPriority", n, e._path, !1), Hi("setWithPriority", t, !1), ".length" === e.key || ".keys" === e.key)) throw "setWithPriority failed: " + e.key + " is a read-only object.";
                ...
                (fo.update = function (e, n) {
                  ...
                  return (
                    (function (r, o, e, a) {
                      ...
                      if (
                        (z(e, (e, n) => {
                          (t = !1), (s[e] = Ci(ke(o, e), dn(n), r.serverSyncTree_, i));
                        }),
                        t)
                      )
                        N("update() called with empty data.  Don't do anything."), br(0, a, "ok", void 0);
                      else {
                        const l = dr(r);
                        var n = (function (e, n, t, i) {
                          !(function (e, n, t, i) {
                            (0, f.assert)(i > e.lastWriteId, "Stacking an older merge on top of newer ones"),
                              e.allWrites.push({ path: n, children: t, writeId: i, visible: !0 }),
              ...
              class o {
                ...
                set(e, n) {
                  null == n ? this.domStorage_.removeItem(this.prefixedName_(e)) : this.domStorage_.setItem(this.prefixedName_(e), (0, f.stringify)(n));
                }
                get(e) {
                ...
                p = function (e) {
                  try {
                    if ("undefined" != typeof window && void 0 !== window[e]) {
                      const n = window[e];
                      return n.setItem("firebase:sentinel", "cache"), n.removeItem("firebase:sentinel"), new o(n);
                    }
                  } catch (e) {}
                  return new a();
                };
              function g(e) {
                ...
                const n = new f.Sha1();
                return n.update(e), (e = n.digest()), f.base64.encodeByteArray(e);
              }
              const m = p("localStorage"),
                ...
                v = function (...n) {
                  ...
                  for (let e = 0; e < n.length; e++) {
                    var i = n[e];
                    Array.isArray(i) || (i && "object" == typeof i && "number" == typeof i.length) ? (t += v.apply(null, i)) : (t += "object" == typeof i ? (0, f.stringify)(i) : i), (t += " ");
                  }
                  return t;
                };
              let w = null,
              ...
              function I(e, n) {
                ...
                throw new Error("Missing required key (" + e + ") in object: " + (0, f.stringify)(n));
              }
              function T(n) {
                if ("object" != typeof n || null === n) return (0, f.stringify)(n);
                const t = [];
                for (const e in n) t.push(e);
                t.sort();
                let i = "{";
                for (let e = 0; e < t.length; e++) 0 !== e && (i += ","), (i += (0, f.stringify)(t[e])), (i += ":"), (i += T(n[t[e]]));
                return (i += "}"), i;
              }
              function S(n, t) {
                var i = n.length;
                if (i <= t) return [n];
                const r = [];
                for (let e = 0; e < i; e += t) e + t > i ? r.push(n.substring(e, i)) : r.push(n.substring(e, e + t));
                return r;
              }
              const P = function (e, n) {
                  (0, f.assert)(!n || !0 === e || !1 === e, "Can't turn on custom loggers persistently."),
                    !0 === e ? ((_.logLevel = i.LogLevel.VERBOSE), (w = _.log.bind(_)), n && b.set("logging_enabled", !0)) : "function" == typeof e ? (w = e) : ((w = null), b.remove("logging_enabled"));
                },
                N = function (...e) {
                  !0 === x && ((x = !1), null === w && !0 === b.get("logging_enabled") && P(!0)), w && ((e = v.apply(null, e)), w(e));
                },
                R = function (...e) {
                ...
                L = function (e, n) {
                  ...
                  var t = B(e),
                    i = B(n);
                  return null !== t ? (null !== i ? (t - i == 0 ? e.length - n.length : t - i) : -1) : null === i && e < n ? -1 : 1;
                };
              function z(e, n) {
              ...
              function j(e) {
                ...
                0 === e
                  ...
                  : ((n = e < 0),
                    (e = Math.abs(e)),
                    (i = e >= Math.pow(2, -1022) ? ((r = Math.min(Math.floor(Math.log(e) / Math.LN2), 1023)), (t = r + 1023), Math.round(e * Math.pow(2, 52 - r) - Math.pow(2, 52))) : ((t = 0), Math.round(e / Math.pow(2, -1074)))));
                const a = [];
                for (o = 52; o; --o) a.push(i % 2 ? 1 : 0), (i = Math.floor(i / 2));
                for (o = 11; o; --o) a.push(t % 2 ? 1 : 0), (t = Math.floor(t / 2));
              ...
              class V {
                constructor(e, n) {
                  (this.appName_ = e), (this.appCheckProvider = n), (this.appCheck = null == n ? void 0 : n.getImmediate({ optional: !0 })), this.appCheck || (null != n && n.get().then((e) => (this.appCheck = e)));
                }
                getToken(t) {
                ...
                addTokenChangeListener(n) {
                  var e;
                  null !== (e = this.appCheckProvider) && void 0 !== e && e.get().then((e) => e.addTokenListener(n));
                }
                notifyForInvalidToken() {
                  O(`Provided AppCheck credentials for the app named "${this.appName_}" ` + "are invalid. This usually indicates your app was not initialized correctly.");
                }
              }
              class Y {
                constructor(e, n, t) {
                  (this.appName_ = e), (this.firebaseOptions_ = n), (this.authProvider_ = t), (this.auth_ = null), (this.auth_ = t.getImmediate({ optional: !0 })), this.auth_ || t.onInit((e) => (this.auth_ = e));
                }
                getToken(t) {
                  return this.auth_
                    ? this.auth_.getToken(t).catch((e) => (e && "auth/token-not-initialized" === e.code ? (N("Got auth/token-not-initialized error.  Treating as null token."), null) : Promise.reject(e)))
                    : new Promise((e, n) => {
                        setTimeout(() => {
                ...
                addTokenChangeListener(n) {
                  this.auth_ ? this.auth_.addAuthTokenListener(n) : this.authProvider_.get().then((e) => e.addAuthTokenListener(n));
                }
                removeTokenChangeListener(n) {
                  this.authProvider_.get().then((e) => e.removeAuthTokenListener(n));
                }
                notifyForInvalidToken() {
              ...
              function J(e, n, t) {
                (0, f.assert)("string" == typeof n, "typeof type must == string"), (0, f.assert)("object" == typeof t, "typeof params must == object");
                let i;
                if (n === Q) i = (e.secure ? "wss://" : "ws://") + e.internalHost + "/.ws?";
                else {
                  if (n !== K) throw new Error("Unknown connection type: " + n);
                  i = (e.secure ? "https://" : "http://") + e.internalHost + "/.lp?";
                }
                ((n = e).host !== n.internalHost || n.isCustomHost() || n.includeNamespaceInQueryParams) && (t.ns = e.namespace);
                const r = [];
                return (
                  z(t, (e, n) => {
                    r.push(e + "=" + n);
              ...
              class Z {
                ...
                incrementCounter(e, n = 1) {
                  (0, f.contains)(this.counters_, e) || (this.counters_[e] = 0), (this.counters_[e] += n);
                }
                get() {
              ...
              class re {
                constructor(e, n, t, i, r, o, a) {
                  (this.connId = e),
                    ...
                    (this.log_ = k(e)),
                    (this.stats_ = te(n)),
                    (this.urlFn = (e) => (this.appCheckToken && (e.ac = this.appCheckToken), J(n, K, e)));
                }
                open(e, n) {
                  (this.curSegmentNum = 0),
                    ...
                    (function (n) {
                      if ((0, f.isNodeSdk)() || "complete" === document.readyState) n();
                      else {
                        let e = !1;
                        const t = function () {
                      ...
                      if (!this.isClosed_) {
                        this.scriptTagHolder = new oe(
                          (...e) => {
                            ...
                            if ((this.incrementIncomingBytes_(e), this.scriptTagHolder))
                              if ((this.connectTimeoutTimer_ && (clearTimeout(this.connectTimeoutTimer_), (this.connectTimeoutTimer_ = null)), (this.everConnected_ = !0), "start" === n)) (this.id = t), (this.password = i);
                              else {
                          ...
                          (...e) => {
                            var [n, t] = e;
                            this.incrementIncomingBytes_(e), this.myPacketOrderer.handleResponse(n, t);
                          },
                          () => {
                            this.onClosed_();
                          },
                        ...
                        (n.ser = Math.floor(1e8 * Math.random())),
                          this.scriptTagHolder.uniqueCallbackIdentifier && (n.cb = this.scriptTagHolder.uniqueCallbackIdentifier),
                          (n.v = "5"),
                          this.transportSessionId && (n.s = this.transportSessionId),
                          ...
                          "undefined" != typeof location && location.hostname && $.test(location.hostname) && (n.r = "f");
                        var e = this.urlFn(n);
                ...
                addDisconnectPingFrame(e, n) {
                  if (!(0, f.isNodeSdk)()) {
                    ...
                    const t = { dframe: "t" };
                    (t.id = e), (t.pw = n), (this.myDisconnFrame.src = this.urlFn(t)), (this.myDisconnFrame.style.display = "none"), document.body.appendChild(this.myDisconnFrame);
                  }
                }
              ...
              class oe {
                constructor(n, t, e, i) {
                  if (((this.onDisconnect = e), (this.urlFn = i), (this.outstandingRequests = new Set()), (this.pendingSegs = []), (this.currentSerial = Math.floor(1e8 * Math.random())), (this.sendNewPolls = !0), (0, f.isNodeSdk)()))
                    (this.commandCB = n), (this.onMessageCB = t);
                  else {
                    (this.uniqueCallbackIdentifier = y()), (window["pLPCommand" + this.uniqueCallbackIdentifier] = n), (window["pRTLPCB" + this.uniqueCallbackIdentifier] = t), (this.myIFrame = oe.createIFrame_());
                    let e = "";
                    this.myIFrame.src && "javascript:" === this.myIFrame.src.substr(0, "javascript:".length) && ((r = document.domain), (e = '<script>document.domain="' + r + '";</script>'));
                ...
                static createIFrame_() {
                  ...
                  if (((n.style.display = "none"), !document.body)) throw "Document body has not initialized. Wait to initialize Firebase until after the document is ready.";
                  document.body.appendChild(n);
                  try {
                    n.contentWindow.document || N("No IE domain setting required");
                  } catch (e) {
                    var t = document.domain;
                    n.src = "javascript:void((function(){document.open();document.domain='" + t + "';document.close();})())";
                  }
                  return n.contentDocument ? (n.doc = n.contentDocument) : n.contentWindow ? (n.doc = n.contentWindow.document) : n.document && (n.doc = n.document), n;
                }
                close() {
                  (this.alive = !1),
                    this.myIFrame &&
                ...
                newRequest_() {
                  if (this.alive && this.sendNewPolls && this.outstandingRequests.size < (0 < this.pendingSegs.length ? 2 : 1)) {
                    this.currentSerial++;
                    const r = {};
                    (r.id = this.myID), (r.pw = this.myPW), (r.ser = this.currentSerial);
                    var t = this.urlFn(r);
                    let e = "",
                      n = 0;
                    for (; 0 < this.pendingSegs.length; ) {
                      ...
                      (e = e + "&seg" + n + "=" + i.seg + "&ts" + n + "=" + i.ts + "&d" + n + "=" + i.d), n++;
                    }
                ...
                enqueueSegment(e, n, t) {
                  this.pendingSegs.push({ seg: e, ts: n, d: t }), this.alive && this.newRequest_();
                }
                addLongPollTag_(e, n) {
                    ...
                    : setTimeout(() => {
                        try {
                          ...
                          (n.type = "text/javascript"),
                            ...
                            (n.onerror = () => {
                              N("Long-poll script failed to load: " + e), (this.sendNewPolls = !1), this.close();
                            }),
              ...
              class se {
                ...
                static connectionURL_(e, n, t, i) {
                  const r = { v: "5" };
                  return !(0, f.isNodeSdk)() && "undefined" != typeof location && location.hostname && $.test(location.hostname) && (r.r = "f"), n && (r.s = n), t && (r.ls = t), i && (r.ac = i), J(e, Q, r);
                }
                open(e, n) {
                  (this.onDisconnect = n), (this.onMessage = e), this.log_("Websocket connecting to " + this.connURL), (this.everConnected_ = !1), m.set("previous_websocket_failure", !0);
                  try {
                    if ((0, f.isNodeSdk)()) {
                      var t = this.nodeAdmin ? "AdminNode" : "Node";
                      const a = { headers: { "User-Agent": `Firebase/5/${s}/${uo.platform}/${t}`, "X-Firebase-GMPID": this.applicationId || "" } };
                      this.authToken && (a.headers.Authorization = `Bearer ${this.authToken}`), this.appCheckToken && (a.headers["X-Firebase-AppCheck"] = this.appCheckToken);
                      var i = uo.env,
                        r = 0 === this.connURL.indexOf("wss://") ? i.HTTPS_PROXY || i.https_proxy : i.HTTP_PROXY || i.http_proxy;
                      r && (a.proxy = { origin: r }), (this.mySock = new ae(this.connURL, [], a));
                    } else {
                      var o = { headers: { "X-Firebase-GMPID": this.applicationId || "", "X-Firebase-AppCheck": this.appCheckToken || "" } };
                ...
                static isAvailable() {
                  ...
                  var n;
                  return (
                    "undefined" == typeof navigator || !navigator.userAgent || ((n = navigator.userAgent.match(/Android ([0-9]{0,}\.[0-9]{0,})/)) && 1 < n.length && parseFloat(n[1]) < 4.4 && (e = !0)),
                ...
                appendFrame_(e) {
                  this.frames.push(e), this.frames.length === this.totalFrames && ((e = this.frames.join("")), (e = ((this.frames = null), f.jsonEval)(e)), this.onMessage(e));
                }
                handleNewFrameCount_(e) {
                  (this.totalFrames = e), (this.frames = []);
                }
                extractFrameCount_(e) {
                  if (((0, f.assert)(null === this.frames, "We already have a frame buffer"), e.length <= 6)) {
                    var n = Number(e);
                ...
                handleIncomingFrame(e) {
                  null !== this.mySock &&
                    ...
                    this.resetKeepAlive(),
                    null !== this.frames ? this.appendFrame_(e) : null !== (e = this.extractFrameCount_(e)) && this.appendFrame_(e));
                }
                send(e) {
                  this.resetKeepAlive();
                  e = (0, f.stringify)(e);
              ...
              class le {
                ...
                initTransports_(e) {
                  ...
                  if ((e.webSocketOnly && (n || O("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."), (t = !0)), t)) this.transports_ = [se];
                  else {
                    const i = (this.transports_ = []);
                    for (const r of le.ALL_TRANSPORTS) r && r.isAvailable() && i.push(r);
                  }
                }
                initialTransport() {
              ...
              class ce {
                ...
                disconnReceiver_(n) {
                  return (e) => {
                    n === this.conn_ ? this.onConnectionLost_(e) : n === this.secondaryConn_ ? (this.log_("Secondary connection lost."), this.onSecondaryConnectionLost_()) : this.log_("closing an old connection");
                  };
                }
                connReceiver_(n) {
                  return (e) => {
                    2 !== this.state_ && (n === this.rx_ ? this.onPrimaryMessageReceived_(e) : n === this.secondaryConn_ ? this.onSecondaryMessageReceived_(e) : this.log_("message on old connection"));
                  };
                }
                sendRequest(e) {
                ...
                onPrimaryMessageReceived_(e) {
                  var n = I("t", e),
                    e = I("d", e);
                  "c" === n ? this.onControl_(e) : "d" === n && this.onDataMessage_(e);
                }
                onDataMessage_(e) {
                ...
                onHandshake_(e) {
                  var n = e.ts,
                    t = e.v,
                    i = e.h;
                  (this.sessionId = e.s), (this.repoInfo_.host = i), 0 === this.state_ && (this.conn_.start(), this.onConnectionEstablished_(this.conn_, n), "5" !== t && O("Protocol version mismatch detected"), this.tryStartUpgrade_());
                }
                tryStartUpgrade_() {
                ...
                onConnectionLost_(e) {
                  (this.conn_ = null),
                    e || 0 !== this.state_
                      ...
                      : (this.log_("Realtime connection failed."), this.repoInfo_.isCacheableHost() && (m.remove("host:" + this.repoInfo_.host), (this.repoInfo_.internalHost = this.repoInfo_.host))),
                    this.close();
                }
              ...
              class he {
                constructor(e) {
                  (this.allowedEvents_ = e), (this.listeners_ = {}), (0, f.assert)(Array.isArray(e) && 0 < e.length, "Requires a non-empty array");
                }
                trigger(e, ...n) {
                  if (Array.isArray(this.listeners_[e])) {
                    const t = [...this.listeners_[e]];
                    for (let e = 0; e < t.length; e++) t[e].callback.apply(t[e].context, n);
                  }
                }
                on(e, n, t) {
                  this.validateEventType_(e), (this.listeners_[e] = this.listeners_[e] || []), this.listeners_[e].push({ callback: n, context: t });
                ...
                off(e, n, t) {
                  ...
                  for (let e = 0; e < i.length; e++) if (i[e].callback === n && (!t || t === i[e].context)) return void i.splice(e, 1);
                }
              ...
              class ue extends he {
                ...
                getInitialEvent(e) {
                  return (0, f.assert)("online" === e, "Unknown event type: " + e), [this.online_];
                }
                currentlyOnline() {
                  return this.online_;
                }
              ...
              class ge {
                constructor(e, n) {
                  if (void 0 === n) {
                    ...
                    let n = 0;
                    for (let e = 0; e < this.pieces_.length; e++) 0 < this.pieces_[e].length && ((this.pieces_[n] = this.pieces_[e]), n++);
                    (this.pieces_.length = n), (this.pieceNum_ = 0);
                  } else (this.pieces_ = e), (this.pieceNum_ = n);
                }
                toString() {
                  let n = "";
                  for (let e = this.pieceNum_; e < this.pieces_.length; e++) "" !== this.pieces_[e] && (n += "/" + this.pieces_[e]);
                  return n || "/";
                }
              }
              function me() {
              ...
              function ke(n, t) {
                const i = [];
                for (let e = n.pieceNum_; e < n.pieces_.length; e++) i.push(n.pieces_[e]);
                if (t instanceof ge) for (let e = t.pieceNum_; e < t.pieces_.length; e++) i.push(t.pieces_[e]);
                else {
                  var r = t.split("/");
                  for (let e = 0; e < r.length; e++) 0 < r[e].length && i.push(r[e]);
                }
                return new ge(i, 0);
              }
              function Ce(e) {
              ...
              function Te(t, i) {
                ...
                for (let e = t.pieceNum_, n = i.pieceNum_; e <= t.pieces_.length; e++, n++) if (t.pieces_[e] !== i.pieces_[n]) return !1;
                return !0;
              }
              function Se(e, n) {
                let t = e.pieceNum_,
              ...
              class Pe {
                constructor(e, n) {
                  (this.errorPrefix_ = n), (this.parts_ = we(e, 0)), (this.byteLength_ = Math.max(1, this.parts_.length));
                  for (let e = 0; e < this.parts_.length; e++) this.byteLength_ += (0, f.stringLength)(this.parts_[e]);
                  Ne(this);
                }
              }
              function Ne(e) {
                if (e.byteLength_ > fe) throw new Error(e.errorPrefix_ + "has a key path longer than " + fe + " bytes (" + e.byteLength_ + ").");
                if (e.parts_.length > pe) throw new Error(e.errorPrefix_ + "path specified exceeds the maximum depth that can be written (" + pe + ") or object contains a cycle " + Re(e));
              }
              function Re(e) {
              ...
              class Oe extends he {
                constructor() {
                  ...
                  "undefined" != typeof document &&
                    ...
                    (void 0 !== document.hidden
                      ...
                      : void 0 !== document.webkitHidden && ((e = "webkitvisibilitychange"), (n = "webkitHidden"))),
                    (this.visible_ = !0),
                    e &&
                      document.addEventListener(
                        e,
                ...
                getInitialEvent(e) {
                  return (0, f.assert)("visible" === e, "Unknown event type: " + e), [this.visible_];
                }
              }
              class De extends de {
                constructor(e, n, t, i, r, o, a, s) {
                  ...
                  Oe.getInstance().on("visible", this.onVisible_, this), -1 === e.host.indexOf("fblocal") && ue.getInstance().on("online", this.onOnline_, this);
                }
                sendRequest(e, n, t) {
                  var i = ++this.requestNumber_,
                    n = { r: i, a: e, b: n };
                  this.log_((0, f.stringify)(n)), (0, f.assert)(this.connected_, "sendRequest call when we're not connected not allowed."), this.realtime_.sendRequest(n), t && (this.requestCBHash_[i] = t);
                }
                get(e) {
                  ...
                  const t = new f.Deferred(),
                    ...
                    n = {
                      ...
                      onComplete: (e) => {
                        var n = e.d;
                        "ok" === e.s ? (this.onDataUpdate_(i.p, n, !1, null), t.resolve(n)) : t.reject(n);
                      },
                    };
                ...
                listen(e, n, t, i) {
                  ...
                  this.log_("Listen called for " + o + " " + r),
                    ...
                    (0, f.assert)(e._queryParams.isDefault() || !e._queryParams.loadsAllData(), "listen() called for non-default but complete query"),
                    (0, f.assert)(!this.listens.get(o).has(r), "listen() called twice for same path/queryId.");
                  t = { onComplete: i, hashFn: n, query: e, tag: t };
                  this.listens.get(o).set(r, t), this.connected_ && this.sendListen_(t);
                }
                sendGet_(n) {
                  const t = this.outstandingGets_[n];
                  this.sendRequest("g", t.request, (e) => {
                    delete this.outstandingGets_[n], this.outstandingGetCount_--, 0 === this.outstandingGetCount_ && (this.outstandingGets_ = []), t.onComplete && t.onComplete(e);
                  });
                }
                sendListen_(i) {
                  const r = i.query,
                  ...
                  i.tag && ((e.q = r._queryObject), (e.t = i.tag)),
                    ...
                    this.sendRequest("q", e, (e) => {
                      var n = e.d,
                        t = e.s;
                      De.warnOnListenWarnings_(n, r), (this.listens.get(o) && this.listens.get(o).get(a)) === i && (this.log_("listen response", e), "ok" !== t && this.removeListen_(o, a), i.onComplete && i.onComplete(t, n));
                    });
                }
                static warnOnListenWarnings_(e, n) {
                  if (e && "object" == typeof e && (0, f.contains)(e, "w")) {
                    ...
                    Array.isArray(t) &&
                      ~t.indexOf("no_index") &&
                      ((e = '".indexOn": "' + n._queryParams.getIndex().toString() + '"'),
                      (n = n._path.toString()),
                      O("Using an unspecified index. Your data will be downloaded and " + `filtered on the client. Consider adding ${e} at ` + `${n} to your security rules for better performance.`));
                  }
                }
                refreshAuthToken(e) {
                ...
                reduceReconnectDelayIfAdminCredential_(e) {
                  ((e && 40 === e.length) || (0, f.isAdmin)(e)) && (this.log_("Admin auth credential detected.  Reducing max reconnect time."), (this.maxReconnectDelay_ = 3e4));
                }
                refreshAppCheckToken(e) {
                  ...
                  if (this.connected_ && this.authToken_) {
                    ...
                    null === this.authOverride_ ? (n.noauth = !0) : "object" == typeof this.authOverride_ && (n.authvar = this.authOverride_),
                      this.sendRequest(e, n, (e) => {
                        var n = e.s,
                          e = e.d || "error";
                        this.authToken_ === t && ("ok" === n ? (this.invalidAuthTokenCount_ = 0) : this.onAuthRevoked_(n, e));
                      });
                  }
                }
                tryAppCheck() {
                  this.connected_ &&
                    ...
                    this.sendRequest("appcheck", { token: this.appCheckToken_ }, (e) => {
                      var n = e.s,
                        e = e.d || "error";
                      "ok" === n ? (this.invalidAppCheckTokenCount_ = 0) : this.onAppCheckRevoked_(n, e);
                    });
                }
                unlisten(e, n) {
                  ...
                  this.log_("Unlisten called for " + t + " " + i),
                    (0, f.assert)(e._queryParams.isDefault() || !e._queryParams.loadsAllData(), "unlisten() called for non-default but complete query"),
                    this.removeListen_(t, i) && this.connected_ && this.sendUnlisten_(t, i, e._queryObject, n);
                }
                ...
                onDisconnectPut(e, n, t) {
                  this.initConnection_(), this.connected_ ? this.sendOnDisconnect_("o", e, n, t) : this.onDisconnectRequestQueue_.push({ pathString: e, action: "o", data: n, onComplete: t });
                }
                onDisconnectMerge(e, n, t) {
                  this.initConnection_(), this.connected_ ? this.sendOnDisconnect_("om", e, n, t) : this.onDisconnectRequestQueue_.push({ pathString: e, action: "om", data: n, onComplete: t });
                }
                onDisconnectCancel(e, n) {
                  this.initConnection_(), this.connected_ ? this.sendOnDisconnect_("oc", e, null, n) : this.onDisconnectRequestQueue_.push({ pathString: e, action: "oc", data: null, onComplete: n });
                }
                ...
                putInternal(e, n, t, i, r) {
                  this.initConnection_();
                  const o = { p: n, d: t };
                  void 0 !== r && (o.h = r), this.outstandingPuts_.push({ action: e, request: o, onComplete: i }), this.outstandingPutCount_++;
                  i = this.outstandingPuts_.length - 1;
                  this.connected_ ? this.sendPut_(i) : this.log_("Buffering put: " + n);
                }
                sendPut_(n) {
                  ...
                  (this.outstandingPuts_[n].queued = this.connected_),
                    this.sendRequest(t, e, (e) => {
                      this.log_(t + " response", e), delete this.outstandingPuts_[n], this.outstandingPutCount_--, 0 === this.outstandingPutCount_ && (this.outstandingPuts_ = []), i && i(e.s, e.d);
                    });
                }
                reportStats(e) {
                  this.connected_ &&
                    ...
                    this.sendRequest("s", e, (e) => {
                      "ok" !== e.s && ((e = e.d), this.log_("reportStats", "Error sending stats: " + e));
                    }));
                }
                onDataMessage_(e) {
                  if ("r" in e) {
                ...
                onDataPush_(e, n) {
                  this.log_("handleServerMessage", e, n),
                    "d" === e
                      ...
                      : C("Unrecognized action received from server: " + (0, f.stringify)(e) + "\nAre you using the latest client?");
                }
                onReady_(e, n) {
                ...
                scheduleConnect_(e) {
                  (0, f.assert)(!this.realtime_, "Scheduling a connect when we're already connected/ing?"),
                ...
                onVisible_(e) {
                  e && !this.visible_ && this.reconnectDelay_ === this.maxReconnectDelay_ && (this.log_("Window became visible.  Reducing delay."), (this.reconnectDelay_ = 1e3), this.realtime_ || this.scheduleConnect_(0)),
                    (this.visible_ = e);
                }
                onOnline_(e) {
                  ...
                  if (this.shouldReconnect_()) {
                    ...
                    this.realtime_ = {
                      ...
                      sendRequest: function (e) {
                        (0, f.assert)(t, "sendRequest call when we're not connected not allowed."), t.sendRequest(e);
                      },
                    };
                    var s = this.forceTokenRefresh_;
                    this.forceTokenRefresh_ = !1;
                    try {
                      var [l, c] = await Promise.all([this.authTokenProvider_.getToken(s), this.appCheckTokenProvider_.getToken(s)]);
                      n
                        ...
                        : (N("getToken() completed. Creating connection."),
                          ...
                          (t = new ce(
                            ...
                            d,
                            (e) => {
                              O(e + " (" + this.repoInfo_.toString() + ")"), this.interrupt("server_kill");
                            },
                            o
                          )));
                    } catch (e) {
                      this.log_("Failed to get token: " + e), n || (this.repoInfo_.nodeAdmin && O(e), a());
                    }
                  }
                }
                interrupt(e) {
                ...
                resume(e) {
                  N("Resuming connection for reason: " + e), delete this.interruptReasons_[e], (0, f.isEmpty)(this.interruptReasons_) && ((this.reconnectDelay_ = 1e3), this.realtime_ || this.scheduleConnect_(0));
                }
                handleTimestamp_(e) {
                  e -= new Date().getTime();
                ...
                cancelSentTransactions_() {
                  for (let e = 0; e < this.outstandingPuts_.length; e++) {
                    ...
                    n && "h" in n.request && n.queued && (n.onComplete && n.onComplete("disconnect"), delete this.outstandingPuts_[e], this.outstandingPutCount_--);
                  }
                ...
                removeListen_(e, n) {
                  ...
                  if (this.listens.has(e)) {
                    ...
                    (t = i.get(n)), i.delete(n), 0 === i.size && this.listens.delete(e);
                  } else t = void 0;
                  return t;
                }
                onAuthRevoked_(e, n) {
                  N("Auth token revoked: " + e + "/" + n),
                    ...
                    ("invalid_token" !== e && "permission_denied" !== e) || (this.invalidAuthTokenCount_++, 3 <= this.invalidAuthTokenCount_ && ((this.reconnectDelay_ = 3e4), this.authTokenProvider_.notifyForInvalidToken()));
                }
                onAppCheckRevoked_(e, n) {
                  N("App check token revoked: " + e + "/" + n),
                    (this.appCheckToken_ = null),
                    (this.forceTokenRefresh_ = !0),
                    ("invalid_token" !== e && "permission_denied" !== e) || (this.invalidAppCheckTokenCount_++, 3 <= this.invalidAppCheckTokenCount_ && this.appCheckTokenProvider_.notifyForInvalidToken());
                }
                onSecurityDebugPacket_(e) {
                  this.securityDebugCallback_ ? this.securityDebugCallback_(e) : 0 in e;
                }
                restoreState_() {
                  this.tryAuth(), this.tryAppCheck();
                  for (const n of this.listens.values()) for (const t of n.values()) this.sendListen_(t);
                ...
                sendConnectStats_() {
                  const e = {};
                  let n = "js";
                  (0, f.isNodeSdk)() && (n = this.repoInfo_.nodeAdmin ? "admin_node" : "node"),
                    (e["sdk." + n + "." + s.replace(/\./g, "-")] = 1),
                    (0, f.isMobileCordova)() ? (e["framework.cordova"] = 1) : (0, f.isReactNative)() && (e["framework.reactnative"] = 1),
                    this.reportStats(e);
                }
                shouldReconnect_() {
              ...
              class ze extends Me {
                ...
                isDefinedOn(e) {
                  throw (0, f.assertionError)("KeyIndex.isDefinedOn not expected to be called.");
                }
                indexedValueChanged(e, n) {
                  return !1;
                }
                ...
                makePost(e, n) {
                  return (0, f.assert)("string" == typeof e, "KeyIndex indexValue must always be a string."), new Ae(e, Le);
                }
                toString() {
                  return ".key";
                }
              ...
              class Fe {
                constructor(e, n, t, i, r = null) {
                  ...
                  let o = 1;
                  for (; !e.isEmpty(); )
                    if (((o = n ? t(e.key, n) : 1), i && (o *= -1), o < 0)) e = this.isReverse_ ? e.left : e.right;
                    else {
                      if (0 === o) {
                ...
                getNext() {
                  ...
                  let e = this.nodeStack_.pop(),
                    n;
                  if (((n = this.resultGenerator_ ? this.resultGenerator_(e.key, e.value) : { key: e.key, value: e.value }), this.isReverse_)) for (e = e.left; !e.isEmpty(); ) this.nodeStack_.push(e), (e = e.right);
              ...
              class qe {
                constructor(e, n, t, i, r) {
                  (this.key = e), (this.value = n), (this.color = null != t ? t : qe.RED), (this.left = null != i ? i : Ue.EMPTY_NODE), (this.right = null != r ? r : Ue.EMPTY_NODE);
                }
                copy(e, n, t, i, r) {
                  return new qe(null != e ? e : this.key, null != n ? n : this.value, null != t ? t : this.color, null != i ? i : this.left, null != r ? r : this.right);
                }
                count() {
                ...
                insert(e, n, t) {
                  let i = this;
                  var r = t(e, i.key);
                  return (i = r < 0 ? i.copy(null, null, null, i.left.insert(e, n, t), null) : 0 === r ? i.copy(null, n, null, null, null) : i.copy(null, null, null, null, i.right.insert(e, n, t))), i.fixUp_();
                }
                removeMin_() {
                ...
                remove(e, n) {
                  let t, i;
                  if (((t = this), n(e, t.key) < 0)) t.left.isEmpty() || t.left.isRed_() || t.left.left.isRed_() || (t = t.moveRedLeft_()), (t = t.copy(null, null, null, t.left.remove(e, n), null));
                  else {
                    if ((t.left.isRed_() && (t = t.rotateRight_()), t.right.isEmpty() || t.right.isRed_() || t.right.left.isRed_() || (t = t.moveRedRight_()), 0 === n(e, t.key))) {
                      if (t.right.isEmpty()) return Ue.EMPTY_NODE;
                      (i = t.right.min_()), (t = t.copy(i.key, i.value, null, null, t.right.removeMin_()));
                    }
              ...
              class Ue {
                ...
                insert(e, n) {
                  return new Ue(this.comparator_, this.root_.insert(e, n, this.comparator_).copy(null, null, qe.BLACK, null, null));
                }
                remove(e) {
                  return new Ue(this.comparator_, this.root_.remove(e, this.comparator_).copy(null, null, qe.BLACK, null, null));
                }
                get(e) {
                  var n;
                  let t = this.root_;
              ...
              function Ye(e) {
                var n;
                e.isLeafNode()
                  ? ((n = e.val()), (0, f.assert)("string" == typeof n || "number" == typeof n || ("object" == typeof n && (0, f.contains)(n, ".sv")), "Priority must be a string or number."))
                  : (0, f.assert)(e === He || e.isEmpty(), "priority of unexpected type."),
                  (0, f.assert)(e === He || e.getPriority().isEmpty(), "Priority nodes can't have a priority of their own.");
              }
              let Ge;
              class $e {
                constructor(e, n = $e.__childrenNodeConstructor.EMPTY_NODE) {
                  (this.value_ = e), (this.priorityNode_ = n), ((this.lazyHash_ = null), f.assert)(void 0 !== this.value_ && null !== this.value_, "LeafNode shouldn't be created with null/undefined value."), Ye(this.priorityNode_);
                }
                ...
                getChild(e) {
                  return Ce(e) ? this : ".priority" === be(e) ? this.priorityNode_ : $e.__childrenNodeConstructor.EMPTY_NODE;
                }
                hasChild() {
                  return !1;
                }
                ...
                updateImmediateChild(e, n) {
                  return ".priority" === e ? this.updatePriority(n) : n.isEmpty() && ".priority" !== e ? this : $e.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e, n).updatePriority(this.priorityNode_);
                }
                updateChild(e, n) {
                  var t = be(e);
                  return null === t
                    ...
                    ? this
                    : ((0, f.assert)(".priority" !== t || 1 === _e(e), ".priority must be the last token in a path"), this.updateImmediateChild(t, $e.__childrenNodeConstructor.EMPTY_NODE.updateChild(ye(e), n)));
                }
                isEmpty() {
                  return !1;
                }
                ...
                hash() {
                  if (null === this.lazyHash_) {
                    let e = "";
                    this.priorityNode_.isEmpty() || (e += "priority:" + Ve(this.priorityNode_.val()) + ":");
                    var n = typeof this.value_;
                    (e += n + ":"), (e += "number" == n ? j(this.value_) : this.value_), (this.lazyHash_ = g(e));
                  }
                ...
                compareTo(e) {
                  return e === $e.__childrenNodeConstructor.EMPTY_NODE ? 1 : e instanceof $e.__childrenNodeConstructor ? -1 : ((0, f.assert)(e.isLeafNode(), "Unknown node type"), this.compareToLeafNode_(e));
                }
                compareToLeafNode_(e) {
                  ...
                  return (0, f.assert)(0 <= i, "Unknown leaf type: " + n), (0, f.assert)(0 <= r, "Unknown leaf type: " + t), i === r ? ("object" == t ? 0 : this.value_ < e.value_ ? -1 : this.value_ === e.value_ ? 0 : 1) : r - i;
                }
                withIndex() {
                  return this;
                }
              ...
              class Ze {
                constructor(e) {
                  var n;
                  (this.count = ((n = e + 1), parseInt(Math.log(n) / Je, 10))), (this.current_ = this.count - 1);
                  var t,
              ...
              function en(l, e, c, n) {
                ...
                const d = function (e, n) {
                  ...
                  let i, r;
                  if (0 == t) return null;
                  if (1 == t) return (i = l[e]), (r = c ? c(i) : i), new qe(r, i.node, qe.BLACK, null, null);
                  (t = parseInt(t / 2, 10) + e), (e = d(e, t)), (n = d(t + 1, n));
                  return (i = l[t]), (r = c ? c(i) : i), new qe(r, i.node, qe.BLACK, e, n);
                };
                var t = (function (n) {
                  let r = null,
                    o = null,
              ...
              class rn {
                ...
                static get Default() {
                  return (0, f.assert)((tn, Xe), "ChildrenNode.ts has not been loaded"), (nn = nn || new rn({ ".priority": tn }, { ".priority": Xe })), nn;
                }
                get(e) {
                ...
                addIndex(e, n) {
                  (0, f.assert)(e !== je, "KeyIndex always exists and isn't meant to be added to the IndexMap.");
                  const t = [];
                  let i = !1;
                  const r = n.getIterator(Ae.Wrap);
                  let o = r.getNext();
                  for (; o; ) (i = i || e.isDefinedOn(o.node)), t.push(o), (o = r.getNext());
                  let a;
                ...
                addToIndexes(a, s) {
                  var e = (0, f.map)(this.indexes_, (n, t) => {
                    ...
                    if (((0, f.assert)(i, "Missing index implementation for " + t), n === tn)) {
                      if (i.isDefinedOn(a.node)) {
                        const r = [],
                          o = s.getIterator(Ae.Wrap);
                        let e = o.getNext();
                        for (; e; ) e.name !== a.name && r.push(e), (e = o.getNext());
                    ...
                    }
                    {
                      t = s.get(a.name);
                      let e = n;
                      return t && (e = e.remove(new Ae(a.name, t))), e.insert(a, a.node);
                    }
                  });
              ...
              class an {
                constructor(e, n, t) {
                  (this.children_ = e),
                    ...
                    this.children_.isEmpty() && (0, f.assert)(!this.priorityNode_ || this.priorityNode_.isEmpty(), "An empty node cannot have a priority");
                }
                ...
                updatePriority(e) {
                  return this.children_.isEmpty() ? this : new an(this.children_, e, this.indexMap_);
                }
                getImmediateChild(e) {
                ...
                getChild(e) {
                  var n = be(e);
                  return null === n ? this : this.getImmediateChild(n).getChild(ye(e));
                }
                hasChild(e) {
                  return null !== this.children_.get(e);
                }
                updateImmediateChild(t, i) {
                  if (((0, f.assert)(i, "We should always be passing snapshot nodes"), ".priority" === t)) return this.updatePriority(i);
                  {
                    var r = new Ae(t, i);
                    let e, n;
                    n = i.isEmpty() ? ((e = this.children_.remove(t)), this.indexMap_.removeFromIndexes(r, this.children_)) : ((e = this.children_.insert(t, i)), this.indexMap_.addToIndexes(r, this.children_));
                ...
                updateChild(e, n) {
                  var t = be(e);
                  if (null === t) return n;
                  (0, f.assert)(".priority" !== be(e) || 1 === _e(e), ".priority must be the last token in a path");
                ...
                val(t) {
                  ...
                  if (
                    (this.forEachChild(Xe, (e, n) => {
                      (i[e] = n.val(t)), r++, a && an.INTEGER_REGEXP_.test(e) ? (o = Math.max(o, Number(e))) : (a = !1);
                    }),
                    !t && a && o < 2 * r)
                  ) {
                    const e = [];
                ...
                hash() {
                  if (null === this.lazyHash_) {
                    let t = "";
                    this.getPriority().isEmpty() || (t += "priority:" + Ve(this.getPriority().val()) + ":"),
                      this.forEachChild(Xe, (e, n) => {
                        n = n.hash();
                        "" !== n && (t += ":" + e + ":" + n);
                      }),
                ...
                forEachChild(e, n) {
                  ...
                  return t ? t.inorderTraversal((e) => n(e.name, e.node)) : this.children_.inorderTraversal(n);
                }
                getIterator(e) {
                ...
                getIteratorFrom(n, t) {
                  ...
                  if (e) return e.getIteratorFrom(n, (e) => e);
                  {
                    ...
                    let e = i.peek();
                    for (; null != e && t.compare(e, n) < 0; ) i.getNext(), (e = i.peek());
                    return i;
                  }
                }
                getReverseIterator(e) {
                ...
                getReverseIteratorFrom(n, t) {
                  ...
                  {
                    const i = this.children_.getReverseIteratorFrom(n.name, Ae.Wrap);
                    let e = i.peek();
                    for (; null != e && 0 < t.compare(e, n); ) i.getNext(), (e = i.peek());
                    return i;
                  }
                }
                compareTo(e) {
                  return this.isEmpty() ? (e.isEmpty() ? 0 : -1) : e.isLeafNode() || e.isEmpty() ? 1 : e === ln ? -1 : 0;
                }
                withIndex(e) {
                    ...
                    if (this.getPriority().equals(t.getPriority())) {
                      if (this.children_.count() !== t.children_.count()) return !1;
                      {
                        ...
                        let e = i.getNext(),
                          n = r.getNext();
                        for (; e && n; ) {
                          if (e.name !== n.name || !e.node.equals(n.node)) return !1;
              ...
              const ln = new sn();
              Object.defineProperties(Ae, { MIN: { value: new Ae(A, an.EMPTY_NODE) }, MAX: { value: new Ae(M, ln) } }), (ze.__EMPTY_NODE = an.EMPTY_NODE), ($e.__childrenNodeConstructor = an), (l = ln), (He = l), (c = ln), (Ke = c);
              const cn = !0;
              function dn(r, e = null) {
                if (null === r) return an.EMPTY_NODE;
                if (
                  ("object" == typeof r && ".priority" in r && (e = r[".priority"]),
                  (0, f.assert)(null === e || "string" == typeof e || "number" == typeof e || ("object" == typeof e && ".sv" in e), "Invalid priority type found: " + typeof e),
                  "object" != typeof (r = "object" == typeof r && ".value" in r && null !== r[".value"] ? r[".value"] : r) || ".sv" in r)
                ) {
                  var n = r;
                  return new $e(n, dn(e));
                }
                  ...
                  return (
                    z(r, (e, n) => {
                      if ((0, f.contains)(r, e) && "." !== e.substring(0, 1)) {
                        const t = dn(n);
                        (!t.isLeafNode() && t.isEmpty()) || (i = i.updateImmediateChild(e, t));
                      }
                    }),
                    i.updatePriority(dn(e))
                  );
                }
                {
                  const o = [];
                  ...
                  if (
                    (z(r, (e, n) => {
                      if ("." !== e.substring(0, 1)) {
                        const t = dn(n);
                        t.isEmpty() || ((i = i || !t.getPriority().isEmpty()), o.push(new Ae(e, t)));
                      }
                    }),
                    0 === o.length)
                  )
                  ...
                  if (i) {
                    ...
                    return new an(t, dn(e), new rn({ ".priority": n }, { ".priority": Xe }));
                  }
                  return new an(t, dn(e), rn.Default);
                }
              }
              Qe = dn;
              class hn extends Me {
                constructor(e) {
                  super(), (this.indexPath_ = e), (0, f.assert)(!Ce(e) && ".priority" !== be(e), "Can't create PathIndex with empty path or .priority key");
                }
                extractChild(e) {
                ...
                makePost(e, n) {
                  (e = dn(e)), (e = an.EMPTY_NODE.updateChild(this.indexPath_, e));
                  return new Ae(n, e);
                }
                maxPost() {
              ...
              function un(n) {
                ...
                let i = t.length - 1;
                for (; 0 <= i && t[i] === bn; ) i--;
                return -1 === i ? M : ((e = t[i]), (e = gn.charAt(gn.indexOf(e) + 1)), (t[i] = e), t.slice(0, i + 1).join(""));
              }
              function pn(n) {
                if (n === "" + U) return A;
                var e = B(n);
                ...
                const t = new Array(n.length);
                for (let e = 0; e < t.length; e++) t[e] = n.charAt(e);
                return t[t.length - 1] === mn ? (1 === t.length ? "" + W : (delete t[t.length - 1], t.join(""))) : ((t[t.length - 1] = gn.charAt(gn.indexOf(t[t.length - 1]) - 1)), t.join("") + bn.repeat(_n - t.length));
              }
              const fn = new (class extends Me {
                ...
                yn = (function () {
                  ...
                  return function (e) {
                    ...
                    let t;
                    const i = new Array(8);
                    for (t = 7; 0 <= t; t--) (i[t] = gn.charAt(e % 64)), (e = Math.floor(e / 64));
                    (0, f.assert)(0 === e, "Cannot push at time == 0");
                    let r = i.join("");
                    if (n) {
                      for (t = 11; 0 <= t && 63 === a[t]; t--) a[t] = 0;
                      a[t]++;
                    } else for (t = 0; t < 12; t++) a[t] = Math.floor(64 * Math.random());
                    for (t = 0; t < 12; t++) r += gn.charAt(a[t]);
                    return (0, f.assert)(20 === r.length, "nextPushId: Length should be 20."), r;
                  };
                })();
              function vn(e) {
              ...
              function kn(e, n, t) {
                return { type: "child_changed", snapshotNode: n, childName: e, oldSnap: t };
              }
              class Cn {
                constructor(e) {
                  this.index_ = e;
                ...
                updateChild(e, n, t, i, r, o) {
                  (0, f.assert)(e.isIndexed(this.index_), "A node must be indexed if only a child is updated");
                  const a = e.getImmediateChild(n);
                  return a.getChild(i).equals(t.getChild(i)) && a.isEmpty() === t.isEmpty()
                    ? e
                    : (null != o &&
                        (t.isEmpty()
                          ? e.hasChild(n)
                            ? o.trackChildChange(xn(n, a))
                            : (0, f.assert)(e.isLeafNode(), "A child remove without an old child only makes sense on a leaf node")
                          : a.isEmpty()
                          ? o.trackChildChange(wn(n, t))
                          : o.trackChildChange(kn(n, t, a))),
                      e.isLeafNode() && t.isEmpty() ? e : e.updateImmediateChild(n, t).withIndex(this.index_));
                }
              ...
              class En {
                constructor(e) {
                  (this.indexedFilter_ = new Cn(e.getIndex())), (this.index_ = e.getIndex()), (this.startPost_ = En.getStartPost_(e)), (this.endPost_ = En.getEndPost_(e));
                }
                getStartPost() {
                ...
                updateChild(e, n, t, i, r, o) {
                  return this.matches(new Ae(n, t)) || (t = an.EMPTY_NODE), this.indexedFilter_.updateChild(e, n, t, i, r, o);
                }
                updateFullNode(e, n, t) {
                  let i = (n = n.isLeafNode() ? an.EMPTY_NODE : n).withIndex(this.index_);
                  i = i.updatePriority(an.EMPTY_NODE);
                  const r = this;
                  return (
                    n.forEachChild(Xe, (e, n) => {
                      r.matches(new Ae(e, n)) || (i = i.updateImmediateChild(e, an.EMPTY_NODE));
                    }),
              ...
              class In {
                constructor(e) {
                  (this.rangedFilter_ = new En(e)), (this.index_ = e.getIndex()), (this.limit_ = e.getLimit()), (this.reverse_ = !e.isViewFromLeft());
                }
                updateChild(e, n, t, i, r, o) {
                  return (
                    this.rangedFilter_.matches(new Ae(n, t)) || (t = an.EMPTY_NODE),
                    e.getImmediateChild(n).equals(t) ? e : e.numChildren() < this.limit_ ? this.rangedFilter_.getIndexedFilter().updateChild(e, n, t, i, r, o) : this.fullLimitUpdateChild_(e, n, t, r, o)
                  );
                }
                updateFullNode(e, a, n) {
                  let s;
                  if (a.isLeafNode() || a.isEmpty()) s = an.EMPTY_NODE.withIndex(this.index_);
                  else if (2 * this.limit_ < a.numChildren() && a.isIndexed(this.index_)) {
                    s = an.EMPTY_NODE.withIndex(this.index_);
                    let n;
                    n = this.reverse_ ? a.getReverseIteratorFrom(this.rangedFilter_.getEndPost(), this.index_) : a.getIteratorFrom(this.rangedFilter_.getStartPost(), this.index_);
                    let t = 0;
                    for (; n.hasNext() && t < this.limit_; ) {
                      var i = n.getNext();
                      let e;
                      if (((e = this.reverse_ ? this.index_.compare(this.rangedFilter_.getStartPost(), i) <= 0 : this.index_.compare(i, this.rangedFilter_.getEndPost()) <= 0), !e)) break;
                      (s = s.updateImmediateChild(i.name, i.node)), t++;
                    }
                  } else {
                    (s = a.withIndex(this.index_)), (s = s.updatePriority(an.EMPTY_NODE));
                    let e, n, t, i;
                    if (this.reverse_) {
                      (i = s.getReverseIterator(this.index_)), (e = this.rangedFilter_.getEndPost()), (n = this.rangedFilter_.getStartPost());
                      const c = this.index_.getCompare();
                      t = (e, n) => c(n, e);
                    } else (i = s.getIterator(this.index_)), (e = this.rangedFilter_.getStartPost()), (n = this.rangedFilter_.getEndPost()), (t = this.index_.getCompare());
                    let r = 0,
                      o = !1;
                    for (; i.hasNext(); ) {
                      var l = i.getNext();
                      !o && t(e, l) <= 0 && (o = !0), o && r < this.limit_ && t(l, n) <= 0 ? r++ : (s = s.updateImmediateChild(l.name, an.EMPTY_NODE));
                    }
                  }
                  return this.rangedFilter_.getIndexedFilter().updateFullNode(e, s, n);
                }
                updatePriority(e, n) {
                  return e;
                }
                ...
                fullLimitUpdateChild_(e, n, t, i, r) {
                  ...
                  if (a.hasChild(n)) {
                    var d = a.getImmediateChild(n);
                    let e = i.getChildAfterChild(this.index_, l, this.reverse_);
                    for (; null != e && (e.name === n || a.hasChild(e.name)); ) e = i.getChildAfterChild(this.index_, e, this.reverse_);
                    var h = null == e ? 1 : o(e, s);
                    if (c && !t.isEmpty() && 0 <= h) return null != r && r.trackChildChange(kn(n, t, d)), a.updateImmediateChild(n, t);
                    {
                      null != r && r.trackChildChange(xn(n, d));
                      const p = a.updateImmediateChild(n, an.EMPTY_NODE);
                      return null != e && this.rangedFilter_.matches(e) ? (null != r && r.trackChildChange(wn(e.name, e.node)), p.updateImmediateChild(e.name, e.node)) : p;
                    }
                  }
                  return !t.isEmpty() && c && 0 <= o(l, s) ? (null != r && (r.trackChildChange(xn(l.name, l.node)), r.trackChildChange(wn(n, t))), a.updateImmediateChild(n, t).updateImmediateChild(l.name, an.EMPTY_NODE)) : e;
                }
              }
              class Tn {
                constructor() {
                ...
                getIndexStartValue() {
                  return (0, f.assert)(this.startSet_, "Only valid if start has been set"), this.indexStartValue_;
                }
                getIndexStartName() {
                  return (0, f.assert)(this.startSet_, "Only valid if start has been set"), this.startNameSet_ ? this.indexStartName_ : A;
                }
                hasEnd() {
                  return this.endSet_;
                }
                getIndexEndValue() {
                  return (0, f.assert)(this.endSet_, "Only valid if end has been set"), this.indexEndValue_;
                }
                getIndexEndName() {
                  return (0, f.assert)(this.endSet_, "Only valid if end has been set"), this.endNameSet_ ? this.indexEndName_ : M;
                }
                hasLimit() {
                ...
                getLimit() {
                  return (0, f.assert)(this.limitSet_, "Only valid if limit has been set"), this.limit_;
                }
                getIndex() {
                  return this.index_;
                }
              ...
              function Sn(e, n, t) {
                const i = e.copy();
                return (i.startSet_ = !0), void 0 === n && (n = null), (i.indexStartValue_ = n), null != t ? ((i.startNameSet_ = !0), (i.indexStartName_ = t)) : ((i.startNameSet_ = !1), (i.indexStartName_ = "")), i;
              }
              function Pn(e, n, t) {
                const i = e.copy();
                return (i.endSet_ = !0), void 0 === n && (n = null), (i.indexEndValue_ = n), void 0 !== t ? ((i.endNameSet_ = !0), (i.indexEndName_ = t)) : ((i.endNameSet_ = !1), (i.indexEndName_ = "")), i;
              }
              function Nn(e, n) {
                const t = e.copy();
                return (t.index_ = n), t;
              ...
              function Rn(e) {
                ...
                let t;
                return (
                  (t = e.index_ === Xe ? "$priority" : e.index_ === fn ? "$value" : e.index_ === je ? "$key" : ((0, f.assert)(e.index_ instanceof hn, "Unrecognized index type!"), e.index_.toString())),
                  (n.orderBy = (0, f.stringify)(t)),
                  e.startSet_ && ((n.startAt = (0, f.stringify)(e.indexStartValue_)), e.startNameSet_ && (n.startAt += "," + (0, f.stringify)(e.indexStartName_))),
                  e.endSet_ && ((n.endAt = (0, f.stringify)(e.indexEndValue_)), e.endNameSet_ && (n.endAt += "," + (0, f.stringify)(e.indexEndName_))),
                  e.limitSet_ && (e.isViewFromLeft() ? (n.limitToFirst = e.limit_) : (n.limitToLast = e.limit_)),
                  n
                );
              }
              function On(n) {
                const t = {};
                if ((n.startSet_ && ((t.sp = n.indexStartValue_), n.startNameSet_ && (t.sn = n.indexStartName_)), n.endSet_ && ((t.ep = n.indexEndValue_), n.endNameSet_ && (t.en = n.indexEndName_)), n.limitSet_)) {
                  t.l = n.limit_;
                  let e = n.viewFrom_;
              ...
              class Dn extends de {
                constructor(e, n, t, i) {
                  super(), (this.repoInfo_ = e), (this.onDataUpdate_ = n), (this.authTokenProvider_ = t), (this.appCheckTokenProvider_ = i), (this.log_ = k("p:rest:")), (this.listens_ = {});
                }
                reportStats(e) {
                  throw new Error("Method not implemented.");
                }
                static getListenId_(e, n) {
                  return void 0 !== n ? "tag$" + n : ((0, f.assert)(e._queryParams.isDefault(), "should have a tag if it's not a default query."), e._path.toString());
                }
                listen(e, n, i, r) {
                  ...
                  this.restRequest_(o + ".json", e, (n, e) => {
                    let t = e;
                    if ((null === (n = 404 === n ? (t = null) : n) && this.onDataUpdate_(o, t, !1, i), (0, f.safeGet)(this.listens_, a) === s)) {
                      let e;
                      (e = n ? (401 === n ? "permission_denied" : "rest_error:" + n) : "ok"), r(e, null);
                    }
                  });
                }
                unlisten(e, n) {
                ...
                get(e) {
                  ...
                  return (
                    this.restRequest_(i + ".json", n, (e, n) => {
                      let t = n;
                      null === (e = 404 === e ? (t = null) : e) ? (this.onDataUpdate_(i, t, !1, null), r.resolve(t)) : r.reject(new Error(t));
                    }),
                    r.promise
                  );
                }
                ...
                restRequest_(r, o = {}, a) {
                  return (
                    (o.format = "export"),
                    Promise.all([this.authTokenProvider_.getToken(!1), this.appCheckTokenProvider_.getToken(!1)]).then(([e, n]) => {
                      e && e.accessToken && (o.auth = e.accessToken), n && n.token && (o.ac = n.token);
                      const t = (this.repoInfo_.secure ? "https://" : "http://") + this.repoInfo_.host + r + "?ns=" + this.repoInfo_.namespace + (0, f.querystring)(o);
                      this.log_("Sending REST request for " + t);
                      const i = new XMLHttpRequest();
                      (i.onreadystatechange = () => {
                        if (a && 4 === i.readyState) {
                          this.log_("REST Response for " + t + " received. status:", i.status, "response:", i.responseText);
                          let e = null;
                          if (200 <= i.status && i.status < 300) {
                            try {
                              e = (0, f.jsonEval)(i.responseText);
                            } catch (e) {
                              O("Failed to parse JSON response for " + t + ": " + i.responseText);
                            }
                            a(null, e);
                          } else 401 !== i.status && 404 !== i.status && O("Got unsuccessful REST response for " + t + " Status: " + i.status), a(i.status);
                          a = null;
                        }
                      }),
                        i.open("GET", t, !0),
              ...
              function Ln(e, n, t) {
                var i;
                Ce(n) ? ((e.value = t), e.children.clear()) : null !== e.value ? (e.value = e.value.updateChild(n, t)) : ((i = be(n)), e.children.has(i) || e.children.set(i, Mn()), Ln(e.children.get(i), (n = ye(n)), t));
              }
              function zn(e, t, i) {
                var r;
                null !== e.value
              ...
              class Fn {
                constructor(e, n) {
                  (this.server_ = n), (this.statsToReport_ = {}), (this.statsListener_ = new jn(e));
                ...
                reportStats_() {
                  ...
                  let i = !1;
                  z(e, (e, n) => {
                    0 < n && (0, f.contains)(this.statsToReport_, e) && ((t[e] = n), (i = !0));
                  }),
                    i && this.server_.reportStats(t),
                    F(this.reportStats_.bind(this), Math.floor(2 * Math.random() * 3e5));
                }
              }
              function qn() {
              ...
              ((p = d = d || {})[(p.OVERWRITE = 0)] = "OVERWRITE"), (p[(p.MERGE = 1)] = "MERGE"), (p[(p.ACK_USER_WRITE = 2)] = "ACK_USER_WRITE"), (p[(p.LISTEN_COMPLETE = 3)] = "LISTEN_COMPLETE");
              class Bn {
                constructor(e, n, t) {
                  (this.path = e), (this.affectedTree = n), (this.revert = t), (this.type = d.ACK_USER_WRITE), (this.source = qn());
                }
                operationForChild(e) {
                  if (Ce(this.path)) {
                    if (null != this.affectedTree.value) return (0, f.assert)(this.affectedTree.children.isEmpty(), "affectedTree should not have overlapping affected paths."), this;
                    var n = this.affectedTree.subtree(new ge(e));
                    return new Bn(me(), n, this.revert);
                  }
                  return (0, f.assert)(be(this.path) === e, "operationForChild called for unrelated child."), new Bn(ye(this.path), this.affectedTree, this.revert);
                }
              }
              class Hn {
                constructor(e, n) {
                  (this.source = e), (this.path = n), (this.type = d.LISTEN_COMPLETE);
                }
                operationForChild(e) {
                  return Ce(this.path) ? new Hn(this.source, me()) : new Hn(this.source, ye(this.path));
                }
              }
              class Vn {
                constructor(e, n, t) {
                  (this.source = e), (this.path = n), (this.snap = t), (this.type = d.OVERWRITE);
                }
                operationForChild(e) {
                  return Ce(this.path) ? new Vn(this.source, me(), this.snap.getImmediateChild(e)) : new Vn(this.source, ye(this.path), this.snap);
                }
              }
              class Yn {
                constructor(e, n, t) {
                  (this.source = e), (this.path = n), (this.children = t), (this.type = d.MERGE);
                }
                operationForChild(e) {
                  if (Ce(this.path)) {
                    const n = this.children.subtree(new ge(e));
                    return n.isEmpty() ? null : n.value ? new Vn(this.source, me(), n.value) : new Yn(this.source, me(), n);
                  }
                  return (0, f.assert)(be(this.path) === e, "Can't get a merge for a child not on the path of the operation"), new Yn(this.source, ye(this.path), this.children);
                }
                toString() {
              ...
              class Gn {
                constructor(e, n, t) {
                  (this.node_ = e), (this.fullyInitialized_ = n), (this.filtered_ = t);
                }
                isFullyInitialized() {
              ...
              function Qn(t, e, n, i) {
                ...
                return (
                  e.forEach((e) => {
                    var n;
                    "child_changed" === e.type && t.index_.indexedValueChanged(e.oldSnap, e.snapshotNode) && o.push(((n = e.childName), { type: "child_moved", snapshotNode: e.snapshotNode, childName: n }));
                  }),
              ...
              function Kn(o, a, n, e, s, l) {
                ...
                t.sort((e, n) =>
                  (function (e, n, t) {
                    if (null == n.childName || null == t.childName) throw (0, f.assertionError)("Should only compare child_ events.");
                    (n = new Ae(n.childName, n.snapshotNode)), (t = new Ae(t.childName, t.snapshotNode));
                    return e.index_.compare(n, t);
                  })(o, e, n)
                ),
                  t.forEach((n) => {
                    const t = ((e = o), (r = l), "value" === (i = n).type || "child_removed" === i.type || (i.prevName = r.getPredecessorChildName(i.childName, i.snapshotNode, e.index_)), i);
                    var e, i, r;
                    s.forEach((e) => {
              ...
              class it {
                ...
                findRootMostMatchingPathAndValue(e, n) {
                  if (null != this.value && n(this.value)) return { path: me(), value: this.value };
                  if (Ce(e)) return null;
                  {
                    var t = be(e);
                    ...
                    return null == n ? null : { path: ke(new ge(t), n.path), value: n.value };
                  }
                }
                ...
                remove(n) {
                  if (Ce(n)) return this.children.isEmpty() ? new it(null) : new it(null, this.children);
                  {
                    var t = be(n);
                    const i = this.children.get(t);
                    if (i) {
                      ...
                      let e;
                      return (e = r.isEmpty() ? this.children.remove(t) : this.children.insert(t, r)), null === this.value && e.isEmpty() ? new it(null) : new it(this.value, e);
                    }
                    return this;
                  }
                }
                ...
                setTree(n, t) {
                  if (Ce(n)) return t;
                  {
                    ...
                    const r = this.children.get(i) || new it(null),
                      o = r.setTree(ye(n), t);
                    let e;
                    return (e = o.isEmpty() ? this.children.remove(i) : this.children.insert(i, o)), new it(this.value, e);
                  }
                }
                fold(e) {
                ...
                foreachOnPath_(e, n, t) {
                  if (Ce(e)) return this;
                  {
                    ...
                    var i = be(e);
                    const r = this.children.get(i);
                    return r ? r.foreachOnPath_(ye(e), ke(n, i), t) : new it(null);
                  }
                }
                foreach(e) {
                  this.foreach_(me(), e);
              ...
              function ot(n, t, i) {
                ...
                if (null != r) {
                  ...
                  let e = r.value;
                  r = Ee(o, t);
                  return (e = e.updateChild(r, i)), new rt(n.writeTree_.set(o, e));
                }
              ...
              function ct(e, n) {
                ...
                return null != t ? e.writeTree_.get(t.path).getChild(Ee(t.path, n)) : null;
              }
              function dt(e) {
                const t = [],
              ...
              function ht(e, n) {
                if (Ce(n)) return e;
                var t = ct(e, n);
                return null != t ? new rt(new it(t)) : new rt(e.writeTree_.subtree(n));
              }
              function ut(e) {
                    ...
                    if (null != e.value) return o.updateChild(r, e.value);
                    {
                      ...
                      return (
                        e.children.inorderTraversal((e, n) => {
                          ".priority" === e ? ((0, f.assert)(null !== n.value, "Priority writes must always be leaf nodes"), (t = n.value)) : (o = i(ke(r, e), n, o));
                        }),
                        (o = !o.getChild(r).isEmpty() && null !== t ? o.updateChild(ke(r, ".priority"), t) : o)
                      );
                    }
                  }
                })(me(), e.writeTree_, n);
              ...
              function gt(n, t) {
                ...
                (0, f.assert)(0 <= i, "removeWrite called with nonexistent writeId.");
                    ...
                    (function (e, n) {
                      {
                        ...
                        for (const t in e.children) if (e.children.hasOwnProperty(t) && Se(ke(e.path, t), n)) return !0;
                        return !1;
                      }
                    })(l, r.path)
                      ? (o = !1)
                ...
                return (
                  !!o &&
                  (a
                    ? (((e = n).visibleWrites = bt(e.allWrites, mt, me())), 0 < e.allWrites.length ? (e.lastWriteId = e.allWrites[e.allWrites.length - 1].writeId) : (e.lastWriteId = -1))
                    : r.snap
              ...
              function bt(n, t, i) {
                ...
                for (let e = 0; e < n.length; ++e) {
                  ...
                  if (t(a)) {
                    var o = a.path;
                    let e;
                    if (a.snap) Se(i, o) ? ((e = Ee(i, o)), (r = ot(r, e, a.snap))) : Se(o, i) && ((e = Ee(o, i)), (r = ot(r, me(), a.snap.getChild(e))));
                    else {
                      if (!a.children) throw (0, f.assertionError)("WriteRecord should have .snap or .children");
              ...
              function _t(e, n, t, i, r) {
                  ...
                  if (r || null != t || lt(o, me()))
                    return pt(
                      bt(
                        e.allWrites,
                        function (e) {
                          return (e.visible || r) && (!i || !~i.indexOf(e.writeId)) && (Se(e.path, n) || Se(n, e.path));
                        },
                        n
                      ),
                      t || an.EMPTY_NODE
                ...
                if (null != o) return o;
                e = ht(e.visibleWrites, n);
                return ut(e) ? t : null != t || lt(e, me()) ? pt(e, t || an.EMPTY_NODE) : null;
              }
              function yt(e, n, t, i) {
              ...
              function vt(e, n) {
                return (function (e, n, t) {
                  ...
                  if (t) {
                    const o = ht(e.visibleWrites, n);
                    return (
                      t.forEachChild(Xe, (e, n) => {
                        n = pt(ht(o, new ge(e)), n);
                        i = i.updateImmediateChild(e, n);
                      }),
                      dt(o).forEach((e) => {
                  ...
                  return (
                    dt(ht(e.visibleWrites, n)).forEach((e) => {
                      i = i.updateImmediateChild(e.name, e.node);
                    }),
                    i
                  );
              ...
              function wt(e, n, t, i) {
                return (
                  ...
                  (n = n),
                  (i = i),
                  (0, f.assert)(t || i, "Either existingEventSnap or existingServerSnap must exist"),
                  (e = ke(e, n)),
                  lt(r.visibleWrites, e) ? null : ut((e = ht(r.visibleWrites, e))) ? i.getChild(n) : pt(e, i.getChild(n))
                );
                var r;
              }
              function xt(e, n) {
                return (t = e.writeTree), (n = ke(e.treePath, n)), ct(t.visibleWrites, n);
                var t;
              }
              function kt(e, n, t, i, r, o) {
                return (function (e, n, t, i, r, o, a) {
                  let s;
                  if (((e = ht(e.visibleWrites, n)), null != (n = ct(e, me())))) s = n;
                  else {
                    if (null == t) return [];
                    s = pt(e, t);
                  }
                  if (((s = s.withIndex(a)), s.isEmpty() || s.isLeafNode())) return [];
                  {
                    const l = [],
                      c = a.getCompare(),
                      d = o ? s.getReverseIteratorFrom(i, a) : s.getIteratorFrom(i, a);
                    let e = d.getNext();
                    for (; e && l.length < r; ) 0 !== c(e, i) && l.push(e), (e = d.getNext());
                    return l;
                  }
                })(e.writeTree, e.treePath, n, t, i, r, o);
              }
              function Ct(e, n, t) {
                return (i = e.writeTree), (r = e.treePath), (e = t), (n = ke(r, (t = n))), null != (r = ct(i.visibleWrites, n)) ? r : e.isCompleteForChild(t) ? pt(ht(i.visibleWrites, n), e.getNode().getImmediateChild(t)) : null;
                var i, r;
              }
              function Et(e, n) {
              ...
              class Tt {
                ...
                trackChildChange(e) {
                  var n = e.type,
                    t = e.childName;
                  (0, f.assert)("child_added" === n || "child_changed" === n || "child_removed" === n, "Only child changes supported for tracking"), (0, f.assert)(".priority" !== t, "Only non-priority child changes can be tracked.");
                  var i = this.changeMap.get(t);
                  if (i) {
                    var r = i.type;
                    if ("child_added" === n && "child_removed" === r) this.changeMap.set(t, kn(t, e.snapshotNode, i.snapshotNode));
                    else if ("child_removed" === n && "child_added" === r) this.changeMap.delete(t);
                    else if ("child_removed" === n && "child_changed" === r) this.changeMap.set(t, xn(t, i.oldSnap));
                    else if ("child_changed" === n && "child_added" === r) this.changeMap.set(t, wn(t, e.snapshotNode));
                    else {
                      if ("child_changed" !== n || "child_changed" !== r) throw (0, f.assertionError)("Illegal combination of changes: " + e + " occurred after " + i);
              ...
              class Pt {
                constructor(e, n, t = null) {
                  (this.writes_ = e), (this.viewCache_ = n), (this.optCompleteServerCache_ = t);
                }
                getCompleteChild(e) {
                  const n = this.viewCache_.eventCache;
                  if (n.isCompleteForChild(e)) return n.getNode().getImmediateChild(e);
                  var t = null != this.optCompleteServerCache_ ? new Gn(this.optCompleteServerCache_, !0, !1) : this.viewCache_.serverCache;
                  return Ct(this.writes_, e, t);
                }
                getChildAfterChild(e, n, t) {
                  var i = null != this.optCompleteServerCache_ ? this.optCompleteServerCache_ : nt(this.viewCache_),
              ...
              function Nt(e, n, t, i, r) {
                const o = new Tt();
                let a, s;
                if (t.type === d.OVERWRITE) {
                  var l = t;
                  a = l.source.fromUser
                    ? Dt(e, n, l.path, l.snap, i, r, o)
                    : ((0, f.assert)(l.source.fromServer, "Unknown source."), (s = l.source.tagged || (n.serverCache.isFiltered() && !Ce(l.path))), Ot(e, n, l.path, l.snap, i, r, s, o));
                } else if (t.type === d.MERGE) {
                  var c = t;
                  a = c.source.fromUser
                    ...
                    : ((0, f.assert)(c.source.fromServer, "Unknown source."), (s = c.source.tagged || n.serverCache.isFiltered()), Lt(e, n, c.path, c.children, i, r, s, o));
                } else if (t.type === d.ACK_USER_WRITE) {
                  c = t;
                  a = c.revert
                        ...
                        let l;
                        {
                          if (null != xt(o, r)) return i;
                          {
                            ...
                            if (Ce(r) || ".priority" === be(r)) {
                              let e;
                              (e = i.serverCache.isFullyInitialized() ? yt(o, nt(i)) : ((c = i.serverCache.getNode()), (0, f.assert)(c instanceof an, "serverChildren would be complete if leaf node"), vt(o, c))),
                                (e = e),
                                (n = t.filter.updateFullNode(d, e, s));
                            } else {
                              var c = be(r);
                              let e = Ct(o, c, i.serverCache);
                              null == e && i.serverCache.isCompleteForChild(c) && (e = d.getImmediateChild(c)),
                                (n = null != e ? t.filter.updateChild(d, c, e, ye(r), a, s) : i.eventCache.getNode().hasChild(c) ? t.filter.updateChild(d, c, an.EMPTY_NODE, ye(r), a, s) : d),
                                n.isEmpty() && i.serverCache.isFullyInitialized() && ((l = yt(o, nt(i))), l.isLeafNode() && (n = t.filter.updateFullNode(n, l, s)));
                            }
                            return (l = i.serverCache.isFullyInitialized() || null != xt(o, me())), Jn(i, n, l, t.filter.filtersNodes());
                          }
                        }
                      })(e, n, c.path, i, r, o)
                    : (function (e, n, r, t, o, a, s) {
                        ...
                        {
                          if (null != t.value) {
                            if ((Ce(r) && c.isFullyInitialized()) || c.isCompleteForPath(r)) return Ot(e, n, r, c.getNode().getChild(r), o, a, l, s);
                            if (Ce(r)) {
                              let t = new it(null);
                              return (
                          ...
                          }
                          {
                            ...
                            return (
                              t.foreach((e, n) => {
                                var t = ke(r, e);
                                c.isCompleteForPath(t) && (i = i.set(e, c.getNode().getChild(t)));
                              }),
                              Lt(e, n, r, i, o, a, l, s)
                            );
                          }
                  ...
                  if (t.type !== d.LISTEN_COMPLETE) throw (0, f.assertionError)("Unknown operation type: " + t.type);
                  a = (function (e, n, t, i, r) {
                    const o = n.serverCache,
                      a = Zn(n, o.getNode(), o.isFullyInitialized() || Ce(t), o.isFiltered());
                ...
                return (
                  (function (e, n, t) {
                    ...
                    if (i.isFullyInitialized()) {
                      ...
                      const o = et(e);
                      (0 < t.length || !e.eventCache.isFullyInitialized() || (r && !i.getNode().equals(o)) || !i.getNode().getPriority().equals(o.getPriority())) && t.push(vn(et(n)));
                    }
                  })(n, a, i),
              ...
              function Rt(i, r, o, a, s, l) {
                ...
                if (null != xt(a, o)) return r;
                {
                  ...
                  if (Ce(o)) {
                    var e;
                    (0, f.assert)(r.serverCache.isFullyInitialized(), "If change path is empty, we must have complete server data"),
                      (n = r.serverCache.isFiltered()
                        ? ((e = vt(a, (e = nt(r)) instanceof an ? e : an.EMPTY_NODE)), i.filter.updateFullNode(r.eventCache.getNode(), e, l))
                        : ((d = yt(a, nt(r))), i.filter.updateFullNode(r.eventCache.getNode(), d, l)));
                  } else {
                    var d = be(o);
                    if (".priority" === d) {
                      (0, f.assert)(1 === _e(o), "Can't have a priority with additional path components");
                      var h = c.getNode();
                      t = r.serverCache.getNode();
                      var u = wt(a, o, h, t);
                      n = null != u ? i.filter.updatePriority(h, u) : c.getNode();
                    } else {
                      h = ye(o);
                      let e;
                      (e = c.isCompleteForChild(d) ? ((t = r.serverCache.getNode()), null != (u = wt(a, o, c.getNode(), t)) ? c.getNode().getImmediateChild(d).updateChild(h, u) : c.getNode().getImmediateChild(d)) : Ct(a, d, r.serverCache)),
                        (n = null != e ? i.filter.updateChild(c.getNode(), d, e, h, s, l) : c.getNode());
                    }
                  }
                  return Jn(r, n, c.isFullyInitialized() || Ce(o), i.filter.filtersNodes());
                }
              }
              function Ot(e, n, t, i, r, o, a, s) {
                ...
                if (Ce(t)) c = d.updateFullNode(l.getNode(), i, null);
                else if (d.filtersNodes() && !l.isFiltered()) {
                  var h = l.getNode().updateChild(t, i);
                  ...
                  i = u.updateChild(h, i);
                  c = ".priority" === a ? d.updatePriority(l.getNode(), i) : d.updateChild(l.getNode(), a, i, h, St, null);
                }
                n = Zn(n, c, l.isFullyInitialized() || Ce(t), d.filtersNodes());
                return Rt(e, n, t, r, new Pt(r, n, o), s);
              }
              function Dt(n, t, i, r, e, o, a) {
                const s = t.eventCache;
                let l, c;
                const d = new Pt(e, t, o);
                if (Ce(i)) (c = n.filter.updateFullNode(t.eventCache.getNode(), r, a)), (l = Jn(t, c, !0, n.filter.filtersNodes()));
                else {
                  o = be(i);
                  if (".priority" === o) (c = n.filter.updatePriority(t.eventCache.getNode(), r)), (l = Jn(t, c, s.isFullyInitialized(), s.isFiltered()));
                  else {
                    i = ye(i);
                    ...
                    if (Ce(i)) e = r;
                      ...
                      e = null != u ? (".priority" === ve(i) && u.getChild(xe(i)).isEmpty() ? u : u.updateChild(i, r)) : an.EMPTY_NODE;
                    }
                    l = h.equals(e) ? t : Jn(t, n.filter.updateChild(s.getNode(), o, e, i, d, a), s.isFullyInitialized(), n.filter.filtersNodes());
                  }
                }
                return l;
              }
              ...
              function Lt(i, r, e, n, o, a, s, l) {
                if (r.serverCache.getNode().isEmpty() && !r.serverCache.isFullyInitialized()) return r;
                let c = r,
                  t;
                ...
                return (
                  t.children.inorderTraversal((e, n) => {
                    d.hasChild(e) && ((n = Mt(0, r.serverCache.getNode().getImmediateChild(e), n)), (c = Ot(i, c, new ge(e), n, o, a, s, l)));
                  }),
                  t.children.inorderTraversal((e, n) => {
                    var t = !r.serverCache.isCompleteForChild(e) && void 0 === n.value;
                    d.hasChild(e) || t || ((n = Mt(0, r.serverCache.getNode().getImmediateChild(e), n)), (c = Ot(i, c, new ge(e), n, o, a, s, l)));
                  }),
                  c
                );
              }
              class zt {
                constructor(e, n) {
                  ...
                  const t = this.query_._queryParams,
                    i = new Cn(t.getIndex()),
                    r = (e = t).loadsAllData() ? new Cn(e.getIndex()) : new (e.hasLimit() ? In : En)(e);
                  ...
                  (this.viewCache_ = Xn(n, e)), (this.eventGenerator_ = new $n(this.query_));
                }
                get query() {
                  return this.query_;
                }
              ...
              function Ft(t, i, n) {
                const r = [];
                if (n) {
                  (0, f.assert)(null == i, "A cancel should cancel all event registrations.");
              ...
              function qt(e, n, t, i) {
                n.type === d.MERGE &&
                  ...
                  ((0, f.assert)(nt(e.viewCache_), "We should always have a full cache before handling merges"), (0, f.assert)(et(e.viewCache_), "Missing event cache, even though we have a server cache"));
                const r = e.viewCache_,
                  o = Nt(e.processor_, r, n, t, i);
                return (
                  (t = e.processor_),
                  (i = o.viewCache),
                  (0, f.assert)(i.eventCache.getNode().isIndexed(t.filter.getIndex()), "Event snap not indexed"),
                  (0, f.assert)(i.serverCache.getNode().isIndexed(t.filter.getIndex()), "Server snap not indexed"),
                  (0, f.assert)(o.viewCache.serverCache.isFullyInitialized() || !r.serverCache.isFullyInitialized(), "Once a server snap is complete, it should never go back"),
              ...
              function Ht(n, t, i, r) {
                ...
                if (null !== e) {
                  e = n.views.get(e);
                  return (0, f.assert)(null != e, "SyncTree gave us an op for an invalid query."), qt(e, t, i, r);
                }
                {
                  let e = [];
              ...
              function Vt(e, t, i, r, o) {
                ...
                if (n) return n;
                {
                  let e = yt(i, o ? r : null),
                    n = !1;
                  n = !!e || ((e = r instanceof an ? vt(i, r) : an.EMPTY_NODE), !1);
              ...
              function Yt(e, n, t, i, r, o) {
                o = Vt(e, n, i, r, o);
                return (
                  e.views.has(n._queryIdentifier) || e.views.set(n._queryIdentifier, o),
                  ...
                  (function (e, n) {
                    ...
                    return t.isFullyInitialized() && i.push(vn(t.getNode())), Ut(e, i, t.getNode(), n);
                  })(o, t)
                );
              }
              function Gt(e, n, t, i) {
                ...
                let a = [];
                var s = Jt(e);
                if ("default" === r) for (var [l, c] of e.views.entries()) (a = a.concat(Ft(c, t, i))), jt(c) && (e.views.delete(l), c.query._queryParams.loadsAllData() || o.push(c.query));
                else {
                  const d = e.views.get(r);
                  d && ((a = a.concat(Ft(d, t, i))), jt(d) && (e.views.delete(r), d.query._queryParams.loadsAllData() || o.push(d.query)));
                }
                return s && !Jt(e) && o.push(((0, f.assert)(Wt, "Reference.ts has not been loaded"), new Wt(n._repo, n._path))), { removed: o, events: a };
              }
              function $t(e) {
                const n = [];
                for (const t of e.views.values()) t.query._queryParams.loadsAllData() || n.push(t);
                return n;
              }
              function Qt(e, n) {
                let t = null;
                for (const i of e.views.values())
                  t =
                    ...
                    (function (e, n) {
                      ...
                      return t && (e.query._queryParams.loadsAllData() || (!Ce(n) && !t.getImmediateChild(be(n)).isEmpty())) ? t.getChild(n) : null;
                    })(i, n);
                return t;
              }
              function Kt(e, n) {
              ...
              function Zt(e) {
                for (const n of e.views.values()) if (n.query._queryParams.loadsAllData()) return n;
                return null;
              }
              let ei;
              let ni = 1;
              class ti {
                constructor(e) {
                  (this.listenProvider_ = e),
                    ...
                    (this.pendingWriteTree_ = { visibleWrites: rt.empty(), allWrites: [], lastWriteId: -1 }),
              ...
              function ii(e, n, t, i, r) {
                ...
                return (
                  ...
                  (l = i),
                  (i = r),
                  (0, f.assert)(l > o.lastWriteId, "Stacking an older write on top of newer ones"),
                  o.allWrites.push({ path: a, snap: s, writeId: l, visible: (i = void 0 === i ? !0 : i) }),
              ...
              function ai(t, e, n, i) {
                ...
                if (o && ("default" === e._queryIdentifier || Xt(o, e))) {
                  ...
                  const d = n.removed;
                  a = n.events;
                  (o = -1 !== d.findIndex((e) => e._queryParams.loadsAllData())), (n = t.syncPointTree_.findOnPath(r, (e, n) => Jt(n)));
                  if (o && !n) {
                    const h = t.syncPointTree_.subtree(r);
                    if (!h.isEmpty()) {
                      var s = h.fold((e, n, i) => {
                      ...
                      for (let e = 0; e < s.length; ++e) {
                        var l = s[e],
                          c = l.query,
                          l = hi(t, l);
                        t.listenProvider_.startListening(bi(c), ui(t, c), l.hashFn, l.onComplete);
                      }
                    }
                  }
                  !n &&
                    ...
                    (function (n, t) {
                      for (let e = 0; e < t.length; ++e) {
                        const o = t[e];
                        var i, r;
                        o._queryParams.loadsAllData() || ((i = pi(o)), (r = n.queryToTagMap.get(i)), n.queryToTagMap.delete(i), n.tagToQueryMap.delete(r));
                      }
                    })(t, d);
                }
                return a;
              ...
              function si(e, n, t) {
                ...
                a ? ((o = o || Jt(a)), (r = r || Qt(a, me()))) : ((a = new Bt()), (e.syncPointTree_ = e.syncPointTree_.set(i, a)));
                let s;
                if (null != r) s = !0;
                else {
                  (s = !1), (r = an.EMPTY_NODE);
                ...
                var l,
                  c = Xt(a, n);
                c || n._queryParams.loadsAllData() || ((d = pi(n)), (0, f.assert)(!e.queryToTagMap.has(d), "View does not exist, but we have a tag"), (l = ni++), e.queryToTagMap.set(d, l), e.tagToQueryMap.set(l, d));
                var d = ft(e.pendingWriteTree_, i);
                let h = Yt(a, n, t, d, r, s);
                return (
                  c ||
                    o ||
                    ((c = Kt(a, n)),
                    (h = h.concat(
                      (function (n, e, t) {
                        const i = e._path,
                          r = ui(n, e),
                          o = hi(n, t),
                          a = n.listenProvider_.startListening(bi(e), r, o.hashFn, o.onComplete),
                          s = n.syncPointTree_.subtree(i);
                        if (r) (0, f.assert)(!Jt(s.value), "If we're adding a query, it shouldn't be shadowed");
                        else {
                          var l = s.fold((e, n, i) => {
              ...
              function ci(e, n) {
                return (function n(t, i, r, o) {
                  {
                    if (Ce(t.path)) return di(t, i, r, o);
                    {
                      const a = i.get(me());
              ...
              function hi(i, n) {
                ...
                return {
                  hashFn: () => {
                    const e = n.viewCache_.serverCache.getNode() || an.EMPTY_NODE;
                    return e.hash();
                  },
                  onComplete: (e) => {
                    if ("ok" === e)
                      return o
                        ? (function (e, n, t) {
                            var i = fi(e, t);
                            if (i) {
                              (t = gi(i)), (i = t.path), (t = t.queryId), (n = Ee(i, n));
                    ...
                    var n,
                      ...
                      e = (function (e, n) {
                        ...
                        const i = new Error(e + " at " + n._path.toString() + ": " + t);
              ...
              function gi(e) {
                var n = e.indexOf("$");
                return (0, f.assert)(-1 !== n && n < e.length - 1, "Bad queryKey."), { queryId: e.substr(n + 1), path: new ge(e.substr(0, n)) };
              }
              function mi(e, n, t) {
                var i = e.syncPointTree_.get(n);
                return (0, f.assert)(i, "Missing sync point for query tag that we're tracking"), Ht(i, t, ft(e.pendingWriteTree_, n), null);
              }
              function bi(e) {
                return e._queryParams.loadsAllData() && !e._queryParams.isDefault() ? ((0, f.assert)(ei, "Reference.ts has not been loaded"), new ei(e._repo, e._path)) : e;
              }
              class _i {
                constructor(e) {
                  this.node_ = e;
              ...
              function wi(e, n, t) {
                return e && "object" == typeof e
                  ? ((0, f.assert)(".sv" in e, "Unexpected leaf node or priority contents"),
                    "string" == typeof e[".sv"] ? xi(e[".sv"], n, t) : "object" == typeof e[".sv"] ? ki(e[".sv"], n) : void (0, f.assert)(!1, "Unexpected server value: " + JSON.stringify(e, null, 2)))
                  : e;
              }
              const xi = function (e, n, t) {
                ...
                ki = function (e, n, t) {
                  e.hasOwnProperty("increment") || (0, f.assert)(!1, "Unexpected server value: " + JSON.stringify(e, null, 2));
                  e = e.increment;
                  "number" != typeof e && (0, f.assert)(!1, "Unexpected increment value: " + e);
                  const i = n.node();
                  if (((0, f.assert)(null !== i && void 0 !== i, "Expected ChildrenNode.EMPTY_NODE for nulls"), !i.isLeafNode())) return e;
                  const r = i;
                  n = r.getValue();
              ...
              function Ii(e, i, r) {
                ...
                if (e.isLeafNode()) {
                  const a = e;
                  n = wi(a.getValue(), i, r);
                  return n !== a.getValue() || t !== a.getPriority().val() ? new $e(n, dn(t)) : e;
                }
                {
                  const s = e;
                  return (
                    (o = s),
                    t !== s.getPriority().val() && (o = o.updatePriority(new $e(t))),
              ...
              class Ti {
                constructor(e = "", n = null, t = { children: {}, childCount: 0 }) {
              ...
              function Si(e, n) {
                let t = n instanceof ge ? n : new ge(n),
                  ...
                  r = be(t);
                for (; null !== r; ) {
                  var o = (0, f.safeGet)(i.node.children, r) || { children: {}, childCount: 0 };
              ...
              function Di(e) {
                return new ge(null === e.parent ? e.name : Di(e.parent) + "/" + e.name);
              }
              function Ai(e) {
                var n, t, i, r;
                null !== e.parent &&
                  ...
                  r && e ? (delete n.node.children[t], n.node.childCount--, Ai(n)) : r || e || ((n.node.children[t] = i.node), n.node.childCount++, Ai(n)));
              }
              const Mi = /[\[\].#$\/\u0000-\u001F\u007F]/,
                Li = /[\[\].#$\u0000-\u001F\u007F]/,
                zi = 10485760,
                ...
                qi = function (e) {
                  return null === e || "string" == typeof e || ("number" == typeof e && !D(e)) || (e && "object" == typeof e && (0, f.contains)(e, ".sv"));
                },
                Ui = function (e, n, t, i) {
                  (i && void 0 === n) || Wi((0, f.errorPrefix)(e, "value"), n, t);
                },
                Wi = function (o, e, n) {
                  const a = n instanceof ge ? new Pe(n, o) : n;
                  if (void 0 === e) throw new Error(o + "contains undefined " + Re(a));
                  if ("function" == typeof e) throw new Error(o + "contains a function " + Re(a) + " with contents = " + e.toString());
                  if (D(e)) throw new Error(o + "contains " + e.toString() + " " + Re(a));
                  if ("string" == typeof e && e.length > zi / 3 && (0, f.stringLength)(e) > zi) throw new Error(o + "contains a string greater than " + zi + " utf8 bytes " + Re(a) + " ('" + e.substring(0, 50) + "...')");
                  if (e && "object" == typeof e) {
                    ...
                    if (
                      (z(e, (e, n) => {
                        if (".value" === e) i = !0;
                        else if (".priority" !== e && ".sv" !== e && ((r = !0), !ji(e)))
                          throw new Error(o + " contains an invalid key (" + e + ") " + Re(a) + '.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
                        var t;
                        (t = a),
                          (e = e),
                      ...
                      throw new Error(o + ' contains ".value" child ' + Re(a) + " in addition to actual children.");
                  }
                },
                Bi = function (e, n, i, t) {
                  if (!t || void 0 !== n) {
                    const r = (0, f.errorPrefix)(e, "values");
                    if (!n || "object" != typeof n || Array.isArray(n)) throw new Error(r + " must be an object containing the children to replace.");
                    const o = [];
                    z(n, (e, n) => {
                      const t = new ge(e);
                      if ((Wi(r, n, ke(i, t)), ".priority" === ve(t) && !qi(n)))
                        throw new Error(r + "contains an invalid value for '" + t.toString() + "', which must be a valid Firebase priority (a string, finite number, server value, or null).");
                      o.push(t);
                    }),
                      (function (n, e) {
                        let t, i;
                        for (t = 0; t < e.length; t++) {
                          ...
                          for (let e = 0; e < r.length; e++)
                            if ((".priority" !== r[e] || e !== r.length - 1) && !ji(r[e]))
                              throw new Error(n + "contains an invalid key (" + r[e] + ") in path " + i.toString() + '. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
                        }
                        e.sort(Ie);
                        let o = null;
                        for (t = 0; t < e.length; t++) {
                          if (((i = e[t]), null !== o && Se(o, i))) throw new Error(n + "contains a path " + o.toString() + " that is ancestor of another path " + i.toString());
                          o = i;
                        }
                      })(r, o);
                  }
                ...
                Hi = function (e, n, t) {
                  if (!t || void 0 !== n) {
                    if (D(n)) throw new Error((0, f.errorPrefix)(e, "priority") + "is " + n.toString() + ", but must be a valid Firebase priority (a string, finite number, server value, or null).");
                    if (!qi(n)) throw new Error((0, f.errorPrefix)(e, "priority") + "must be a valid Firebase priority (a string, finite number, server value, or null).");
                  }
                },
                Vi = function (e, n, t, i) {
                  if (!((i && void 0 === t) || ji(t))) throw new Error((0, f.errorPrefix)(e, n) + 'was an invalid key = "' + t + '".  Firebase keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]").');
                },
                Yi = function (e, n, t, i) {
                  if (!((i && void 0 === t) || Fi(t))) throw new Error((0, f.errorPrefix)(e, n) + 'was an invalid path = "' + t + '". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"');
                };
              ...
              const Gi = function (e, n, t, i) {
                ...
                $i = function (e, n) {
                  if (".info" === be(n)) throw new Error(e + " failed = Can't modify data under /.info/");
                };
              ...
              const Qi = function (e, n) {
                ...
                if (
                  ...
                  (!ji(n.repoInfo.namespace) && "localhost" !== n.repoInfo.host.split(":")[0]) ||
                  (0 !== t.length && ((t = (t = t) && t.replace(/^\/*\.info(\/|$)/, "/")), !Fi(t)))
                )
                  throw new Error((0, f.errorPrefix)(e, "url") + 'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".');
              };
              class Ki {
                constructor() {
              ...
              function Xi(n, t) {
                ...
                for (let e = 0; e < t.length; e++) {
                  const o = t[e];
                  var r = o.getPath();
                  null === i || Te(r, i.path) || (n.eventLists_.push(i), (i = null)), null === i && (i = { events: [], path: r }), i.events.push(o);
                }
                    ...
                    (t(r.path)
                      ? ((function (n) {
                          for (let e = 0; e < n.events.length; e++) {
                            const i = n.events[e];
                            var t;
                            null !== i && ((n.events[e] = null), (t = i.getEventRunner()), w && N("event: " + i.toString()), H(t));
                          }
                        })(n.eventLists_[e]),
              ...
              function rr(a, e, n) {
                ...
                a.authTokenProvider_.addTokenChangeListener((e) => {
                  ...
                  (a.statsReporter_ = ((e = a.repoInfo_), (n = () => new Fn(a.stats_, a.server_)), (e = e.toString()), ne[e] || (ne[e] = n()), ne[e])),
                  (a.infoData_ = new An()),
              ...
              function sr(e, n, t, i, r) {
                ...
                var o,
                  ...
                  s,
                  l = new ge(n);
                t = e.interceptServerDataCallback_ ? e.interceptServerDataCallback_(n, t) : t;
                let c = [];
                c = r
                  ? i
                    ? ((o = (0, f.map)(t, (e) => dn(e))),
                      (function (e, n, t, i) {
                        var r = fi(e, i);
                        if (r) {
                          (i = gi(r)), (r = i.path), (i = i.queryId), (n = Ee(r, n)), (t = it.fromObject(t));
                          return mi(e, r, new Yn(Wn(i), n, t));
                        }
                        return [];
                      })(e.serverSyncTree_, l, o, r))
                    : ((n = dn(t)), (o = e.serverSyncTree_), (a = l), (s = n), null == (r = fi(o, (n = r))) ? [] : ((n = gi(r)), (r = n.path), (n = n.queryId), (a = Ee(r, a)), mi(o, r, new Vn(Wn(n), a, s))))
                  : i
                  ? ((a = (0, f.map)(t, (e) => dn(e))), (s = e.serverSyncTree_), (i = l), (a = a), (a = it.fromObject(a)), ci(s, new Yn(Un(), i, a)))
                  : ((t = dn(t)), oi(e.serverSyncTree_, l, t));
                let d = l;
                0 < c.length && (d = vr(e, l)), Zi(e.eventQueue_, d, c);
              }
              function lr(e, n) {
                cr(e, "connected", n),
                  !1 === n &&
                  ...
                  "ok" === e &&
                    !(function e(t, n) {
                      ...
                      if (0 < t.children.size) {
                        var i = be(n);
                        return (n = ye(n)), t.children.has(i) && e(t.children.get(i), n) && t.children.delete(i), 0 === t.children.size;
                      }
                      return !0;
                    })(t.onDisconnect_, i),
                    br(0, r, e, n);
              ...
              function fr(e, n, t) {
                let i;
                (i = ".info" === be(n._path) ? ai(e.infoSyncTree_, n, t) : ai(e.serverSyncTree_, n, t)), Ji(e.eventQueue_, n._path, i);
              }
              function gr(e) {
              ...
              function mr(e, ...n) {
                let t = "";
                e.persistentConnection_ && (t = e.persistentConnection_.id + ":"), N(t, ...n);
              }
              function br(e, i, r, o) {
                i &&
                  H(() => {
              ...
              function yr(n, e = n.transactionQueueTree_) {
                if ((e || kr(n, e), Pi(e))) {
                  const t = xr(n, e);
                  (0, f.assert)(0 < t.length, "Sending zero length transaction queue"),
                    t.every((e) => 0 === e.status) &&
                      (function (r, o, a) {
                        ...
                        for (let e = 0; e < a.length; e++) {
                          const d = a[e];
                          (0, f.assert)(0 === d.status, "tryToSendTransactionQueue_: items in queue should all be run."), (d.status = 1), d.retryCount++;
                          var s = Ee(o, d.path);
                          t = t.updateChild(s, d.currentOutputSnapshotRaw);
                        }
                        const l = t.val(!0),
                          c = o;
                        r.server_.put(
                          ...
                          l,
                          (n) => {
                            mr(r, "transaction put response", { path: c.toString(), status: n });
                            let t = [];
                            if ("ok" === n) {
                              const i = [];
                              for (let e = 0; e < a.length; e++)
                                (a[e].status = 2), (t = t.concat(ri(r.serverSyncTree_, a[e].currentWriteId))), a[e].onComplete && i.push(() => a[e].onComplete(null, !0, a[e].currentOutputSnapshotResolved)), a[e].unwatcher();
                              kr(r, Si(r.transactionQueueTree_, o)), yr(r, r.transactionQueueTree_), Zi(r.eventQueue_, o, t);
                              for (let e = 0; e < i.length; e++) H(i[e]);
                            } else {
                              if ("datastale" === n) for (let e = 0; e < a.length; e++) 3 === a[e].status ? (a[e].status = 4) : (a[e].status = 0);
                              else {
                                O("transaction at " + c.toString() + " failed: " + n);
                                for (let e = 0; e < a.length; e++) (a[e].status = 4), (a[e].abortReason = n);
                              }
                              vr(r, o);
                            }
                          },
                  ...
                  (function (r, o, a) {
                    if (0 !== o.length) {
                      ...
                      for (let t = 0; t < o.length; t++) {
                        ...
                        let e = !1,
                          n;
                        if (((0, f.assert)(null !== s, "rerunTransactionsUnderNode_: relativePath should not be null."), 4 === h.status)) (e = !0), (n = h.abortReason), (i = i.concat(ri(r.serverSyncTree_, h.currentWriteId, !0)));
                        else if (0 === h.status)
                          if (h.retryCount >= tr) (e = !0), (n = "maxretry"), (i = i.concat(ri(r.serverSyncTree_, h.currentWriteId, !0)));
                          else {
                            const u = _r(r, h.path, d);
                            h.currentInputSnapshot = u;
                            var l = o[t].update(u.val());
                            if (void 0 !== l) {
                              Wi("transaction failed: Data returned ", l, h.path);
                              let e = dn(l);
                              ("object" == typeof l && null != l && (0, f.contains)(l, ".priority")) || (e = e.updatePriority(u.getPriority()));
                              (s = h.currentWriteId), (l = ar(r)), (l = Ei(e, u, l));
                              (h.currentOutputSnapshotRaw = e),
                                (h.currentOutputSnapshotResolved = l),
                                (h.currentWriteId = dr(r)),
                                d.splice(d.indexOf(s), 1),
                                (i = i.concat(ii(r.serverSyncTree_, h.path, l, h.currentWriteId, h.applyLocally))),
                                (i = i.concat(ri(r.serverSyncTree_, s, !0)));
                            } else (e = !0), (n = "nodata"), (i = i.concat(ri(r.serverSyncTree_, h.currentWriteId, !0)));
                          }
                        Zi(r.eventQueue_, a, i),
                          ...
                          e &&
                            ...
                            o[t].onComplete && ("nodata" === n ? c.push(() => o[t].onComplete(null, !1, o[t].currentInputSnapshot)) : c.push(() => o[t].onComplete(new Error(n), !1, null))));
                      }
              ...
              function wr(e, n) {
                ...
                for (t = be(n); null !== t && void 0 === Pi(i); ) (i = Si(i, t)), (n = ye(n)), (t = be(n));
                return i;
              }
              function xr(e, n) {
                const t = [];
              ...
              function kr(n, e) {
                ...
                if (t) {
                  let n = 0;
                  for (let e = 0; e < t.length; e++) 2 !== t[e].status && ((t[n] = t[e]), n++);
              ...
              function Er(i, e) {
                ...
                if (r) {
                  ...
                  for (let e = 0; e < r.length; e++)
                    3 === r[e].status ||
                      (1 === r[e].status
                        ? ((0, f.assert)(t === e - 1, "All SENT items should be at beginning of queue."), (t = e), (r[e].status = 3), (r[e].abortReason = "set"))
                        : ((0, f.assert)(0 === r[e].status, "Unexpected transaction status in abort"),
                          r[e].unwatcher(),
                          (n = n.concat(ri(i.serverSyncTree_, r[e].currentWriteId, !0))),
                          r[e].onComplete && o.push(r[e].onComplete.bind(null, new Error("set"), !1, null))));
                  -1 === t ? Ni(e, void 0) : (r.length = t + 1), Zi(i.eventQueue_, Di(e), n);
              ...
              const Ir = function (e, n) {
                  var t = Tr(e),
                    i = t.namespace;
                  "firebase.com" === t.domain && R(t.host + " is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),
                    (i && "undefined" !== i) || "localhost" === t.domain || R("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),
                    t.secure ||
                      ("undefined" != typeof window &&
                        window.location &&
                        window.location.protocol &&
                        -1 !== window.location.protocol.indexOf("https:") &&
                        O("Insecure Firebase access from a secure page. Please use https in calls to new Firebase()."));
                  e = "ws" === t.scheme || "wss" === t.scheme;
                  return { repoInfo: new X(t.host, t.secure, i, n, e, "", i !== t.subdomain), path: new ge(t.pathString) };
                },
                Tr = function (i) {
                  let r = "",
                    o = "",
                  ...
                  if ("string" == typeof i) {
                    let e = i.indexOf("//");
                    0 <= e && ((d = i.substring(0, e - 1)), (i = i.substring(e + 2)));
                    let n = i.indexOf("/");
                    -1 === n && (n = i.length);
                    let t = i.indexOf("?");
                    -1 === t && (t = i.length),
                    ...
                    var u = (function (e) {
                      const n = {};
                      for (const i of (e = "?" === e.charAt(0) ? e.substring(1) : e).split("&")) {
                        var t;
                        0 !== i.length && (2 === (t = i.split("=")).length ? (n[decodeURIComponent(t[0])] = decodeURIComponent(t[1])) : O(`Invalid query segment '${i}' in query '${e}'`));
                      }
                      return n;
                    })(i.substring(Math.min(i.length, t)));
                    (e = r.indexOf(":")), 0 <= e ? ((c = "https" === d || "wss" === d), (h = parseInt(r.substring(e + 1), 10))) : (e = r.length);
                    const p = r.slice(0, e);
                    "localhost" === p.toLowerCase() ? (o = "localhost") : p.split(".").length <= 2 ? (o = p) : ((i = r.indexOf(".")), (a = r.substring(0, i).toLowerCase()), (o = r.substring(i + 1)), (l = a)), "ns" in u && (l = u.ns);
                  }
                  return { host: r, port: h, domain: o, subdomain: a, secure: c, scheme: d, pathString: s, namespace: l };
                };
              class Sr {
                constructor(e, n, t, i) {
                  (this.eventType = e), (this.eventRegistration = n), (this.snapshot = t), (this.prevName = i);
                }
                getPath() {
                ...
                toString() {
                  return this.getPath().toString() + ":" + this.eventType + ":" + (0, f.stringify)(this.snapshot.exportVal());
                }
              }
              class Pr {
                constructor(e, n, t) {
                  (this.eventRegistration = e), (this.error = n), (this.path = t);
                }
                getPath() {
                  return this.path;
                }
              ...
              class Nr {
                ...
                onCancel(e) {
                  return (0, f.assert)(this.hasCancelCallback, "Raising a cancel event on a listener with no cancel callback"), this.cancelCallback.call(null, e);
                }
              ...
              class Rr {
                ...
                set(e) {
                  $i("OnDisconnect.set", this._path), Ui("OnDisconnect.set", e, this._path, !1);
                ...
                setWithPriority(e, n) {
                  $i("OnDisconnect.setWithPriority", this._path), Ui("OnDisconnect.setWithPriority", e, this._path, !1), Hi("OnDisconnect.setWithPriority", n, !1);
                  const t = new f.Deferred();
                  return (
                    (function (t, i, e, n, r) {
                      const o = dn(e, n);
                ...
                update(e) {
                  $i("OnDisconnect.update", this._path), Bi("OnDisconnect.update", e, this._path, !1);
                  const n = new f.Deferred();
                  return (
                    (function (t, i, r, o) {
                      if ((0, f.isEmpty)(r)) return N("onDisconnect().update() called with empty data.  Don't do anything."), br(0, o, "ok", void 0);
              ...
              class Or {
                constructor(e, n, t, i) {
                  (this._repo = e), (this._path = n), (this._queryParams = t), (this._orderByCalled = i);
                }
                get key() {
                ...
                isEqual(e) {
                  if (!((e = (0, f.getModularInstance)(e)) instanceof Or)) return !1;
                ...
                toString() {
                  return (
                    ...
                    (function (n) {
                      let t = "";
                      for (let e = n.pieceNum_; e < n.pieces_.length; e++) "" !== n.pieces_[e] && (t += "/" + encodeURIComponent(String(n.pieces_[e])));
                      return t || "/";
                    })(this._path)
                  );
                }
              ...
              function Dr(e, n) {
                if (!0 === e._orderByCalled) throw new Error(n + ": You can't combine multiple orderBy calls.");
              }
              function Ar(e) {
                let n = null,
                  t = null;
                if ((e.hasStart() && (n = e.getIndexStartValue()), e.hasEnd() && (t = e.getIndexEndValue()), e.getIndex() === je)) {
                ...
                } else if (((0, f.assert)(e.getIndex() instanceof hn || e.getIndex() === fn, "unknown index type."), (null != n && "object" == typeof n) || (null != t && "object" == typeof t)))
              ...
              class zr {
                ...
                forEach(t) {
                  ...
                  const e = this._node;
                  return !!e.forEachChild(this._index, (e, n) => t(new zr(n, Fr(this.ref, e), Xe)));
                }
                hasChild(e) {
                  e = new ge(e);
              ...
              function jr(e, n) {
                return (e = (0, f.getModularInstance)(e))._checkNotDeleted("ref"), void 0 !== n ? Fr(e._root, n) : e._root;
              }
              function Fr(e, n) {
                return (null === be((e = (0, f.getModularInstance)(e))._path) ? Gi : Yi)("child", "path", n, !1), new Lr(e._repo, ke(e._path, n));
              }
              function qr(e, n) {
                (e = (0, f.getModularInstance)(e)), $i("set", e._path), Ui("set", n, e._path, !1);
                const t = new f.Deferred();
                return (
                  hr(
                    e._repo,
              ...
              class Ur {
                ...
                createEvent(e, n) {
                  ...
                  return new Sr("value", this, new zr(e.snapshotNode, new Lr(n._repo, n._path), t));
                }
                getEventRunner(e) {
                ...
                createCancelEvent(e, n) {
                  return this.callbackContext.hasCancelCallback ? new Pr(this, e, n) : null;
                }
                matches(e) {
                  return e instanceof Ur && (!e.callbackContext || !this.callbackContext || e.callbackContext.matches(this.callbackContext));
                }
                hasAnyCallback() {
              ...
              class Wr {
                ...
                respondsTo(e) {
                  ...
                  return (n = "children_removed" === n ? "child_removed" : n), this.eventType === n;
                }
                createCancelEvent(e, n) {
                  return this.callbackContext.hasCancelCallback ? new Pr(this, e, n) : null;
                }
                createEvent(e, n) {
                  (0, f.assert)(null != e.childName, "Child events should have a childName.");
                  var t = Fr(new Lr(n._repo, n._path), e.childName),
                    n = n._queryParams.getIndex();
                  return new Sr(e.type, this, new zr(e.snapshotNode, t, n), e.prevName);
                }
                getEventRunner(e) {
              ...
              function Br(t, e, n, i, r) {
                let o;
                if (("object" == typeof i && ((o = void 0), (r = i)), "function" == typeof i && (o = i), r && r.onlyOnce)) {
                  const s = n;
                  r = (e, n) => {
                ...
                return (
                  (function (e, n, t) {
                    let i;
                    (i = ".info" === be(n._path) ? si(e.infoSyncTree_, n, t) : si(e.serverSyncTree_, n, t)), Ji(e.eventQueue_, n._path, i);
                  })(t._repo, t, a),
                  () => fr(t._repo, t, a)
                );
              }
              ...
              class Yr extends (fo.QueryConstraint = Vr) {
                ...
                _apply(e) {
                  ...
                  if ((Mr(n), Ar(n), e._queryParams.hasEnd())) throw new Error("endAt: Starting point was already set (by another call to endAt, endBefore or equalTo).");
              ...
              class Gr extends Vr {
                ...
                _apply(e) {
                  ...
                  var n = (function (e, n, t) {
                    let i, r;
                    return (r = e.index_ === je ? Pn(e, (n = "string" == typeof n ? pn(n) : n), t) : ((i = null == t ? A : pn(t)), Pn(e, n, i))), (r.endBeforeSet_ = !0), r;
                  })(e._queryParams, this._value, this._key);
                  if ((Mr(n), Ar(n), e._queryParams.hasEnd())) throw new Error("endBefore: Starting point was already set (by another call to endAt, endBefore or equalTo).");
                  return new Or(e._repo, e._path, n, e._orderByCalled);
                }
              }
              class $r extends Vr {
                ...
                _apply(e) {
                  ...
                  if ((Mr(n), Ar(n), e._queryParams.hasStart())) throw new Error("startAt: Starting point was already set (by another call to startAt, startBefore or equalTo).");
                  return new Or(e._repo, e._path, n, e._orderByCalled);
                }
              }
              class Qr extends Vr {
                ...
                _apply(e) {
                  ...
                  var n = (function (n, t, i) {
                    let r;
                    if (n.index_ === je) "string" == typeof t && (t = un(t)), (r = Sn(n, t, i));
                    else {
                      let e;
                  ...
                  if ((Mr(n), Ar(n), e._queryParams.hasStart())) throw new Error("startAfter: Starting point was already set (by another call to startAt, startAfter, or equalTo).");
                  return new Or(e._repo, e._path, n, e._orderByCalled);
                }
              }
              class Kr extends Vr {
                ...
                _apply(e) {
                  ...
                  return new Or(
                    ...
                    (function (e, n) {
                      const t = e.copy();
                      return (t.limitSet_ = !0), (t.limit_ = n), (t.viewFrom_ = "l"), t;
              ...
              class Xr extends Vr {
                ...
                _apply(e) {
                  ...
                  return new Or(
                    ...
                    (function (e, n) {
                      const t = e.copy();
                      return (t.limitSet_ = !0), (t.limit_ = n), (t.viewFrom_ = "r"), t;
                    })(e._queryParams, this._limit),
                    e._orderByCalled
                  );
                }
              ...
              class Jr extends Vr {
                ...
                _apply(e) {
                  ...
                  if (Ce(n)) throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");
                  (n = new hn(n)), (n = Nn(e._queryParams, n));
              ...
              class to extends Vr {
                ...
                _apply(e) {
                  if ((Ui("equalTo", this._value, e._path, !1), e._queryParams.hasStart())) throw new Error("equalTo: Starting point was already set (by another call to startAt/startAfter or equalTo).");
                  ...
                  return new Yr(this._value, this._key)._apply(new $r(this._value, this._key)._apply(e));
                }
              }
              (h = Lr), (0, f.assert)(!Wt, "__referenceConstructor has already been defined"), (Wt = h), (u = Lr), (0, f.assert)(!ei, "__referenceConstructor has already been defined"), (ei = u);
              ...
              function ao(e, n, t, i, r) {
                ...
                void 0 === o &&
                  (e.options.projectId || R("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),
                ...
                let a = Ir(o, r),
                  ...
                  l,
                  c = void 0;
                void 0 !== uo && (c = uo.env[io]), c ? ((l = !0), (o = `http://${c}?ns=${s.namespace}`), (a = Ir(o, r)), (s = a.repoInfo)) : (l = !a.repoInfo.secure);
                n = r && l ? new G(G.OWNER) : new Y(e.name, e.options, n);
                Qi("Invalid Firebase Database URL", a), Ce(a.path) || R("Database URL must point to the root of a Firebase Database (not including a child path).");
                t = (function (e, n, t, i) {
                  let r = ro[n.name];
                  r || ((r = {}), (ro[n.name] = r));
                  n = r[e.toURLString()];
                  n && R("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");
              ...
              class so {
                ...
                get _repo() {
                  return this._instanceStarted || (rr(this._repoInternal, this.app.options.appId, this.app.options.databaseAuthVariableOverride), (this._instanceStarted = !0)), this._repoInternal;
                }
                get _root() {
                  return this._rootInternal || (this._rootInternal = new Lr(this._repo, me())), this._rootInternal;
                }
                _delete() {
                  return (
                    null !== this._rootInternal &&
                      ((function (e, n) {
                        const t = ro[n];
                        (t && t[e.key] === e) || R(`Database ${n}(${e.repoInfo_}) has already been deleted.`), gr(e), delete t[e.key];
                ...
                (0, t._registerComponent)(
                  new e.Component(
                    ...
                    (e, { instanceIdentifier: n }) => {
                      return ao(e.getProvider("app").getImmediate(), e.getProvider("auth-internal"), e.getProvider("app-check-internal"), n);
                    },
                    "PUBLIC"
        ...
        { "@firebase/app": 2, "@firebase/component": 3, "@firebase/logger": 5, "@firebase/util": 6, _process: 11 },
      ],
      5: [
        function (e, n, t) {
          "use strict";
                    ...
                    null === o
                      ...
                      : (e, n, ...t) => {
                          var i = t
                            ...
                            .filter((e) => e)
                            .join(" ");
                          n >= (null !== r && void 0 !== r ? r : e.logLevel) && o({ level: a[n].toLowerCase(), message: i, args: t, type: e.name });
                        });
              }
            });
          const i = [];
          var a, r;
          (t.LogLevel = a), ((r = a || (t.LogLevel = a = {}))[(r.DEBUG = 0)] = "DEBUG"), (r[(r.VERBOSE = 1)] = "VERBOSE"), (r[(r.INFO = 2)] = "INFO"), (r[(r.WARN = 3)] = "WARN"), (r[(r.ERROR = 4)] = "ERROR"), (r[(r.SILENT = 5)] = "SILENT");
          const s = { debug: a.DEBUG, verbose: a.VERBOSE, info: a.INFO, warn: a.WARN, error: a.ERROR, silent: a.SILENT },
            o = a.INFO,
            l = { [a.DEBUG]: "log", [a.VERBOSE]: "log", [a.INFO]: "info", [a.WARN]: "warn", [a.ERROR]: "error" },
            c = (e, n) => {
              if (!(n < e.logLevel)) {
                new Date().toISOString();
                e = l[n];
                if (!e) throw new Error(`Attempted to log a message with an invalid logType (value: ${n})`);
              }
            };
          t.Logger = class {
            constructor(e) {
            ...
            !function () {
              ...
              Object.defineProperty(E, "__esModule", { value: !0 }),
                ...
                (E.calculateBackoffMillis = function (e, n = v, t = w) {
                  (t = n * Math.pow(t, e)), (e = Math.round(k * t * (Math.random() - 0.5) * 2));
                ...
                (E.createMockUserToken = function (e, n) {
                  ...
                  var t = n || "demo-project",
                    i = e.iat || 0,
                    n = e.sub || e.user_id;
                  if (!n) throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");
                  e = Object.assign({ iss: `https://securetoken.google.com/${t}`, aud: t, iat: i, exp: i + 3600, auth_time: i, sub: n, user_id: n, firebase: { sign_in_provider: "custom", identities: {} } }, e);
                  return [a(JSON.stringify({ alg: "none", type: "JWT" })), a(JSON.stringify(e)), ""].join(".");
                }),
                ...
                (E.getGlobal = function () {
                  ...
                  if (void 0 === C) throw new Error("Unable to locate global object.");
                  return C;
                }),
                ...
                (E.isElectron = function () {
                  return 0 <= d().indexOf("Electron/");
                }),
                (E.isEmpty = function (e) {
                  for (const n in e) if (Object.prototype.hasOwnProperty.call(e, n)) return !1;
                  return !0;
                }),
                (E.isIE = function () {
                  const e = d();
                ...
                (E.isUWP = function () {
                  return 0 <= d().indexOf("MSAppHost/");
                }),
                (E.issuedAtTime = E.isValidTimestamp = E.isValidFormat = void 0),
                (E.jsonEval = f),
                (E.map = function (e, n, t) {
                  const i = {};
                  for (const r in e) Object.prototype.hasOwnProperty.call(e, r) && (i[r] = n.call(t, e[r], r, e));
                  return i;
                }),
                  ...
                  return Number.isFinite(e)
                    ? e +
                        (function (e) {
                          ...
                          e %= 10;
                          return 1 != e ? (2 != e ? (3 != e ? "th" : "rd") : "nd") : "st";
                        })(e)
                    : `${e}`;
                }),
                ...
                (E.querystringDecode = function (e) {
                  ...
                  return (
                    n.forEach((e) => {
                      var n;
                      e && (([n, e] = e.split("=")), (t[decodeURIComponent(n)] = decodeURIComponent(e)));
                    }),
                    t
                  );
                }),
                ...
                (E.validateCallback = function (e, n, t, i) {
                  if ((!i || t) && "function" != typeof t) throw new Error(y(e, n) + "must be a valid function.");
                }),
                (E.validateContextObject = function (e, n, t, i) {
                  if ((!i || t) && ("object" != typeof t || null === t)) throw new Error(y(e, n) + "must be a valid context object.");
                }),
              ...
              const n = {
                NODE_CLIENT: !(E.validateNamespace = function (e, n, t) {
                  if ((!t || n) && "string" != typeof n) throw new Error(y(e, "namespace") + "must be a valid firebase namespace.");
                }),
                NODE_ADMIN: !1,
              ...
              E.assert = s;
              const t = function (e) {
                return new Error("Firebase Database (" + n.SDK_VERSION + ") INTERNAL ASSERT FAILED: " + e);
              };
              E.assertionError = t;
              function i(t) {
                const i = [];
                ...
                for (let n = 0; n < t.length; n++) {
                  ...
                  e < 128
                    ...
                    : (e < 2048
                        ? (i[r++] = (e >> 6) | 192)
                        : (55296 == (64512 & e) && n + 1 < t.length && 56320 == (64512 & t.charCodeAt(n + 1))
                            ? ((e = 65536 + ((1023 & e) << 10) + (1023 & t.charCodeAt(++n))), (i[r++] = (e >> 18) | 240), (i[r++] = ((e >> 12) & 63) | 128))
                            : (i[r++] = (e >> 12) | 224),
                          (i[r++] = ((e >> 6) & 63) | 128)),
                      (i[r++] = (63 & e) | 128));
                }
              ...
              const r = {
                ...
                encodeByteArray(i, e) {
                  ...
                  for (let t = 0; t < i.length; t += 3) {
                    ...
                    let e = ((15 & l) << 2) | (d >> 6),
                      n = 63 & d;
                    c || ((n = 64), s || (e = 64)), o.push(r[a >> 2], r[((3 & a) << 4) | (l >> 4)], r[e], r[n]);
                  }
                  return o.join("");
                },
                encodeString(e, n) {
                  return this.HAS_NATIVE_SUPPORT && !n ? btoa(e) : this.encodeByteArray(i(e), n);
                },
                decodeString(e, n) {
                    ...
                    : (function (e) {
                        ...
                        for (; t < e.length; ) {
                          ...
                          a < 128
                            ...
                            : 191 < a && a < 224
                            ? ((r = e[t++]), (n[i++] = String.fromCharCode(((31 & a) << 6) | (63 & r))))
                            : 239 < a && a < 365
                            ? ((o = (((7 & a) << 18) | ((63 & e[t++]) << 12) | ((63 & e[t++]) << 6) | (63 & e[t++])) - 65536), (n[i++] = String.fromCharCode(55296 + (o >> 10))), (n[i++] = String.fromCharCode(56320 + (1023 & o))))
                            : ((r = e[t++]), (o = e[t++]), (n[i++] = String.fromCharCode(((15 & a) << 12) | ((63 & r) << 6) | (63 & o))));
                        }
                        return n.join("");
                ...
                decodeStringToByteArray(n, e) {
                  ...
                  for (let e = 0; e < n.length; ) {
                    ...
                    if ((++e, null == r || null == o || null == a || null == s)) throw Error();
                    i.push((r << 2) | (o >> 4)), 64 !== a && (i.push(((o << 4) & 240) | (a >> 2)), 64 !== s && i.push(((a << 6) & 192) | s));
                  }
                  return i;
                },
                init_() {
              ...
              function c(e, n) {
                ...
                for (const i in n) n.hasOwnProperty(i) && "__proto__" !== i && (e[i] = c(e[i], n[i]));
                return e;
              }
              E.base64Decode = l;
              function d() {
              ...
              function e() {
                try {
                  return "[object process]" === Object.prototype.toString.call(C.process);
                } catch (e) {
                  return !1;
                }
              }
              ...
              class h extends Error {
                constructor(e, n, t) {
                  super(n), (this.code = e), (this.customData = t), (this.name = "FirebaseError"), Object.setPrototypeOf(this, h.prototype), Error.captureStackTrace && Error.captureStackTrace(this, u.prototype.create);
                }
              }
              E.FirebaseError = h;
              class u {
              ...
              function g(e) {
                ...
                try {
                  var o = e.split(".");
                  (n = f(l(o[0]) || "")), (t = f(l(o[1]) || "")), (r = o[2]), (i = t.d || {}), delete t.d;
                } catch (e) {}
              ...
              E.isValidTimestamp = function (e) {
                ...
                let t = 0,
                  i = 0;
                return "object" == typeof n && (n.hasOwnProperty("nbf") ? (t = n.nbf) : n.hasOwnProperty("iat") && (t = n.iat), (i = n.hasOwnProperty("exp") ? n.exp : t + 86400)), !!e && !!t && !!i && e >= t && e <= i;
              };
              ...
              E.Sha1 = class {
                ...
                compress_(n, t) {
                  t = t || 0;
                  const i = this.W_;
                  if ("string" == typeof n) for (let e = 0; e < 16; e++) (i[e] = (n.charCodeAt(t) << 24) | (n.charCodeAt(t + 1) << 16) | (n.charCodeAt(t + 2) << 8) | n.charCodeAt(t + 3)), (t += 4);
                  else for (let e = 0; e < 16; e++) (i[e] = (n[t] << 24) | (n[t + 1] << 16) | (n[t + 2] << 8) | n[t + 3]), (t += 4);
                  for (let e = 16; e < 80; e++) {
                  ...
                  let o = this.chain_[0],
                    ...
                    h;
                  for (let e = 0; e < 80; e++) {
                    h = e < 40 ? (e < 20 ? ((d = l ^ (a & (s ^ l))), 1518500249) : ((d = a ^ s ^ l), 1859775393)) : e < 60 ? ((d = (a & s) | (l & (a | s))), 2400959708) : ((d = a ^ s ^ l), 3395469782);
                    var u = (((o << 5) | (o >>> 27)) + d + c + h + i[e]) & 4294967295;
                    (c = l), (l = s), (s = 4294967295 & ((a << 30) | (a >>> 2))), (a = o), (o = u);
                  }
                ...
                update(t, i) {
                  if (null != t) {
                    ...
                    let n = this.inbuf_;
                    for (; e < i; ) {
                      if (0 === n) for (; e <= r; ) this.compress_(t, e), (e += this.blockSize);
                      if ("string" == typeof t) {
                        for (; e < i; )
                          if (((o[n] = t.charCodeAt(e)), ++n, ++e, n === this.blockSize)) {
                ...
                digest() {
                  ...
                  for (let e = this.blockSize - 1; 56 <= e; e--) (this.buf_[e] = 255 & n), (n /= 256);
                  this.compress_(this.buf_);
                  let i = 0;
                  for (let n = 0; n < 5; n++) for (let e = 24; 0 <= e; e -= 8) (t[i] = (this.chain_[n] >> e) & 255), ++i;
                  return t;
                }
              };
              class b {
                ...
                subscribe(e, n, t) {
                  let i;
                  if (void 0 === e && void 0 === n && void 0 === t) throw new Error("Missing Observer.");
                  (i = (function (e, n) {
                ...
                forEachObserver(n) {
                  if (!this.finalized) for (let e = 0; e < this.observers.length; e++) this.sendOne(e, n);
                }
                sendOne(e, n) {
                  this.task.then(() => {
              ...
              E.validateArgCount = function (e, n, t, i) {
                let r;
                if ((i < n ? (r = "at least " + n) : t < i && (r = 0 === t ? "none" : "no more than " + t), r)) {
                  i = e + " failed: Was called with " + i + (1 === i ? " argument." : " arguments.") + " Expects " + r + ".";
                  throw new Error(i);
                }
              };
              E.stringToByteArray = function (t) {
                ...
                for (let n = 0; n < t.length; n++) {
                  let e = t.charCodeAt(n);
                  var o, a;
                  55296 <= e && e <= 56319 && ((o = e - 55296), n++, s(n < t.length, "Surrogate pair missing trail surrogate."), (a = t.charCodeAt(n) - 56320), (e = 65536 + (o << 10) + a)),
                    e < 128
                      ? (i[r++] = e)
                      : (e < 2048 ? (i[r++] = (e >> 6) | 192) : (e < 65536 ? (i[r++] = (e >> 12) | 224) : ((i[r++] = (e >> 18) | 240), (i[r++] = ((e >> 12) & 63) | 128)), (i[r++] = ((e >> 6) & 63) | 128)), (i[r++] = (63 & e) | 128));
                }
                return i;
              };
              E.stringLength = function (n) {
                ...
                for (let e = 0; e < n.length; e++) {
                  ...
                  i < 128 ? t++ : i < 2048 ? (t += 2) : 55296 <= i && i <= 56319 ? ((t += 4), e++) : (t += 3);
                }
                return t;
              };
              const v = 1e3,
        ...
        function (e, n, t) {
          ...
          Object.defineProperty(t, "__esModule", { value: !0 }),
            ...
            (t.__asyncDelegator = function (i) {
              ...
              function n(n, t) {
                e[n] = i[n]
                  ? function (e) {
                      return (r = !r) ? { value: h(i[n](e)), done: "return" === n } : t ? t(e) : e;
                    }
                  : t;
              }
            }),
            (t.__asyncGenerator = function (e, n, t) {
              ...
              function s(e, n) {
                try {
                  (t = o[e](n)).value instanceof h ? Promise.resolve(t.value.v).then(l, c) : d(a[0][2], t);
                } catch (e) {
                  d(a[0][3], e);
                }
                var t;
            ...
            (t.__decorate = function (e, n, t, i) {
              var r,
                o = arguments.length,
                a = o < 3 ? n : null === i ? (i = Object.getOwnPropertyDescriptor(n, t)) : i;
              if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(e, n, t, i);
              else for (var s = e.length - 1; 0 <= s; s--) (r = e[s]) && (a = (o < 3 ? r(a) : 3 < o ? r(n, t, a) : r(n, t)) || a);
                  ...
                  return (function (n) {
                    ...
                    for (; s; )
                      try {
                        ...
                        switch (((o = 0), (n = a ? [2 & n[0], a.value] : n)[0])) {
                          case 0:
                          case 1:
                            a = n;
                            break;
            ...
            (t.__spreadArray = function (e, n, t) {
              if (t || 2 === arguments.length) for (var i, r = 0, o = n.length; r < o; r++) (!i && r in n) || ((i = i || Array.prototype.slice.call(n, 0, r))[r] = n[r]);
              return e.concat(i || Array.prototype.slice.call(n));
            }),
            (t.__spreadArrays = function () {
              for (var e = 0, n = 0, t = arguments.length; n < t; n++) e += arguments[n].length;
              for (var i = Array(e), r = 0, n = 0; n < t; n++) for (var o = arguments[n], a = 0, s = o.length; a < s; a++, r++) i[r] = o[a];
              return i;
            }),
            (t.__values = s);
          var i = function (e, n) {
          ...
          function a(e, n) {
            ...
            var i,
              ...
              a = [];
            try {
              for (; (void 0 === n || 0 < n--) && !(i = o.next()).done; ) a.push(i.value);
            } catch (e) {
              r = { error: e };
            } finally {
              try {
      ...
      11: [
        function (e, n, t) {
          ...
          function s(n) {
            ...
            if ((i === o || !i) && setTimeout) return (i = setTimeout), setTimeout(n, 0);
            try {
              return i(n, 0);
            } catch (e) {
              try {
          ...
          (n.nextTick = function (e) {
            ...
            if (1 < arguments.length) for (var t = 1; t < arguments.length; t++) n[t - 1] = arguments[t];
            c.push(new f(e, n)), 1 !== c.length || d || s(p);
          }),
