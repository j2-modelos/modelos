...
try {
  (function () { /* inits autoexec */
    ...
    j2.mod.builder = {
      incIds : {},
      setUnidade : function(){
        forEach(j2.env.xmls.unidadesAutoriadas.unidades, function(u){
        ...
        //TODO: error handling for not match unidade autorizada
        ...
        switch(scope){
          case 'EXP':
            return {
              ...
              edt : orgContext.edt,
              edtCore : function(){
                return mod.edt.gE('DocEditorInnerCore');
              },
              edtBottom : function(){
                return mod.edt.gE('DocEditorInnerBottom');
              },
      ...
      j2ElementParse : function(j2El, ddEl) {
        ...
        if(j2El.class){
          forEach(j2El.class.split(' '), function(clss){
      ...
      getModVersaoDefinitions : function(){
        ...
        forEach(j2.env.xmls.modelos.modelos, function(mod){
      ...
      parseClassConstruction : function(currPart, clsElement){
        ...
        if(w.j2.mod.clsCnstr[clssNm])
          w.j2.mod.clsCnstr[clssNm].constructor_(args, clsElement);
      },
        ...
        var buildContext = {
          ...
          par : context.par || (function(){ // pc as new
            ...
            if(j2.modelo.par.win.jQuery('#j2ParRow').length)
              return j2.modelo.par.win.jQuery('#j2ParRow')[0]; // pamm
