        ...
        }, 
        {
          ...
          'properties': [
            ...
            },            
            {
              'name': 'tipo',
               'isAttr': true,
               'type': 'ENUM_CALENDARIO_EVENTO_TIPO'
            },            
            {
              'name': 'abrangencia',
               'isAttr': true,
               'type': 'ENUM_CALENDARIO_EVENTO_ABRANGENCIA'
            },            
            {
              'name': 'recorrencia',
               'isAttr': true,
               'type': 'ENUM_CALENDARIO_EVENTO_RECORRENCIA'
            },
            {
           ...
           },
{
      ...
      'emumerations': [
          ...
          /* FOR CalendarioEvento */
          {
            'name': 'ENUM_CALENDARIO_EVENTO_TIPO',
            'literalValues': [
              {
                'name': 'feriado'
              },
          ...
          {
            'name': 'ENUM_CALENDARIO_EVENTO_ABRANGENCIA',
            'literalValues': [
              {
                'name': 'nacional'
              },
          ...
          {
            'name': 'ENUM_CALENDARIO_EVENTO_RECORRENCIA',
            'literalValues': [
              {
                'name': 'anual'
              },
