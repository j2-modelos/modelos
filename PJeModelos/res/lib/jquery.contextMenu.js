/**
 * https://www.jqueryscript.net/menu/Feature-rich-Custom-jQuery-Context-Menu-Plugin-contextMenu.html
...
function jQueryContextMenuFactory(){
                    ...
                    $.each(opt.items, function (key, item) {
                        ...
                        if (item.type && types[item.type]) {
                            ...
                            switch (item.type) {
                                ...
                                case 'sub':
                                    if(item.faClass)
                                        $('<i>', { class : item.faClass }).appendTo($t);
...
function checkJQuery() { // tappac as new
    if (typeof jQ3 !== 'undefined') {
      if (typeof jQ3.ui !== 'undefined')
        jQueryContextMenuFactory();
      else
