  ...
  (function () { /* inits autoexec */
    ...
    pkg.Alvara = {
      ...
      AddCredor : function(_, _$){
        ...
        _t.Expedientes.length === 0 && pkg.Pagina2toN.countDec(); //corrigir a auto incremetação
          ...
          tr2 : _$('<tr>')
            .append(
              _$('<td>').append(
                _$('<img>', {
                  width:'14px',
                  src:'https://pje.tjma.jus.br/pje/img/view.gif',
                  css : {
                    cursor : 'pointer'
                  }
                })
                .click(function(event){
                    pkg.Alvara.DepositoConsultaAction(_, dep, event);
                }))
            ).append(
      ...
      GuiaConsultaAction : function(_, event){
        mod.sup.open('guiaConsulta', function(){          
          var _ = {
            url : '',
            name : 'guiaConsulta',
        ...
        var v = {
          oN : _.guia.numero.val().replace(/\.|[-]/g,'').slice(0,-1),
          ex : _.guia.numero.val()
        };
          
        
        mod.sup.guiaConsulta.$(mod.sup.guiaConsulta.doc).attr('title', 'Consulta guia ' + v.ex);
        jQ.get('http://apisimulador.tjma.jus.br/v1/simuladorCustas/declaracao_boleto?intNumeroBoleto=' + v.oN, function(response, status, object){

          mod.sup.guiaConsulta.$('body').html(response.response.html);
          mod.sup.guiaConsulta.$('body').css(
            {
        ...
        mod.sup.guiaConsulta.win.focus();
      },
      DepositoConsultaAction : function(_, dep, event){
        var wName = 'depositoConsulta-' + dep.pres.conta;
        
        if(mod.sup[wName] && !mod.sup[wName].win.closed){
          mod.sup[wName].win.focus();
          return;
        }
        
        mod.sup.open(wName, function(){          
          var _ = {
            url : '',
            name : wName,
            idProcesso : j2.env.PJeVars.processo.idProcesso,
        ...
        mod.sup[wName].$('<form>', {
          ...
          target : '_self',
          action : 'https://www63.bb.com.br/portalbb/djo/rdo/magistrado/RD02.bbx',
          style : 'display:none;visibility:hidden;'
        }).append(jQ('<input>',{
          type : 'hidden',
          name : 'formularioRD02',
          value : 'formularioRD02'
        })).append(jQ('<input>',{
          type : 'hidden',
          name : 'publicadorformvalue',
          value : ',802,0,4653,2,0,1'
        }))
        .append(jQ('<input>',{ id : 'formularioRD02:numeroProcesso',type : 'text',name : 'formularioRD02:numeroProcesso', value : null}))
        .append(jQ('<input>',{ id : 'formularioRD02:nomeAutor',type : 'text',name : 'formularioRD02:nomeAutor', value : null}))
        .append(jQ('<input>',{ id : 'formularioRD02:cpfCgcAutor',type : 'text',name : 'formularioRD02:cpfCgcAutor', value : null}))
        .append(jQ('<input>',{ id : 'formularioRD02:nomeReu',type : 'text',name : 'formularioRD02:nomeReu', value : null}))
        .append(jQ('<input>',{ id : 'formularioRD02:cpfCgcReu',type : 'text',name : 'formularioRD02:cpfCgcReu', value : null}))
        .append(jQ('<input>',{ id : 'formularioRD02:numeroGuia',type : 'text',name : 'formularioRD02:numeroGuia', value : null}))
        .append(jQ('<input>',{ id : 'javax.faces.ViewState',type : 'text',name : 'javax.faces.ViewState', value : 'j_id58'}))
        .append(jQ('<input>',{
          id : 'formularioRD02:numeroDeposito',
          type : 'text',
          name : 'formularioRD02:numeroDeposito',
          value : dep.pres.conta.replace(/\./g, '')
        })).append(jQ('<input>',{
          id : 'formularioRD02:comboComarcas',
          type : 'text',
          name : 'formularioRD02:comboComarcas',
          value : '1000032'
        })).append(jQ('<input>',{
          id : 'formularioRD02:comboOrgaos',
          type : 'text',
          name : 'formularioRD02:comboOrgaos',
          value : '16324'
        })).append(jQ('<input>',{
          id : 'formularioRD03:botaoContinuar',
          type : 'text',
          name : 'formularioRD03:botaoContinuar',
          value : 'Continuar'
      ...
      Utilities : {
        ...
        getClonedAlvara : function(to) {
          pkg.Alvara.AlvaraEdit.alvExpPage1.clone(true).find('#PagesSections')
    ...
    pkg.AlvaraExpedienteIteration = {
      ...
      AlvaraCredorListedSet : function(alvExp, _G, _$){
        ...
        _.guia.consultaAction.click(function(event){
          pkg.Alvara.GuiaConsultaAction(_, event);
        });
        

        _.guia.numero.j2 = {
          dOb : _.guia.numero.get(0),
          alvExSpan : _alvExp.$.exp.p.find('#seloOnerosoGuia')
        };
        
        _.guia.numero.keypress( function(event){
          pkg.monetario.formatation.filtraNumeros(_.guia.numero.j2.dOb, 18, event);
        });
        _.guia.numero.keyup ( function(event){
          //pkg.monetario.formatation.formataValor(_.guia.numero.j2.dOb, 16, event);          
          pkg.Formatacao.formataGuiaFerj(_.guia.numero.j2.dOb, event);
          _.guia.numero.j2.alvExSpan.text(_.guia.numero.val());
        });   
                
        _.guia.numero.change ( function(event){
          //pkg.monetario.formatation.formataValor(_.guia.numero.j2.dOb, 16, event);
          pkg.Formatacao.formataCpfCnpj(_.guia.numero.j2.dOb, event);
          _.guia.numero.j2.alvExSpan.text(_.guia.numero.val());
        }); 
      ...
      AlvaraCorpoChangesListening : function(alvExp, _G, _$){
        ...
        evBus.on('Alvara.Expedientes.Remove.yes.' + _alvExp.guid, function(){
          ...
          _pkg.Pagina2toN.count > 2 &&_pkg.Pagina2toN.countDec(); 
        ...
        function processAgruparAlvara(_G, _Exps, _CurrExp){          
          ...
          forEach(_Exps, function(_Exp){
            ...
            var _del = _Exp.$.edt.thead.find('#alvara-delete-action');
            ...
            if(_Exp.grouping && _Exp.grouping.length)
              jQ(_del).hide('slow');
            else
              jQ(_del).show('slow');
