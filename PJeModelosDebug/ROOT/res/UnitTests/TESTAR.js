/*   * ASS: Locação de Imóvel  * DOC: 5231041  * MOD: xmlParser.js  *   * Moddle para XML SAV parser  */  try {
  (function () {
    ...
    wm._19 = function () {
      ...
      var DEFAULT_NS_MAP = {'xsi': 'http://www.w3.org/2001/XMLSchema-instance'};
      ...
      return  {'DEFAULT_NS_MAP': DEFAULT_NS_MAP, 'nameToAlias': nameToAlias, 'aliasToName': aliasToName, 'XSI_TYPE': XSI_TYPE, 'serializeAsType': serializeAsType, 'serializeAsProperty': serializeAsProperty};
    };
    wm._20 = function () {
      var reduce = new window.j2.mod._._96, forEach = new window.j2.mod._._92, find = new window.j2.mod._._91, assign = new window.j2.mod._._206, defer = new window.j2.mod._._101;
      var Stack = new window.j2.mod._._23, SaxParser = (new window.j2.mod._._22).parser, Moddle = new window.j2.mod._._24, parseNameNs = new window.j2.mod._._29;
      Types = new window.j2.mod._._32, coerceType = Types.coerceType, isSimpleType = Types.isSimple, common = new window.j2.mod._._19, XSI_TYPE = common.XSI_TYPE, XSI_URI = common.DEFAULT_NS_MAP.xsi, serializeAsType = common.serializeAsType, aliasToName = common.aliasToName;
      ...
      function normalizeType(node, attr, model) {
        ...
        var uri = node.ns[nameNs.prefix || ''], localName = nameNs.localName, pkg = uri && model.getPackage(uri), typePrefix;
        if (pkg) {
      ...
      ElementHandler.prototype.createElement = function (node) {
        var attributes = parseNodeAttributes(node), Type = this.type, descriptor = getModdleDescriptor(Type), context = this.context, instance = new Type({});
        forEach(attributes, function (value, name) {
          var prop = descriptor.propertiesByName[name], values;
          if (prop && prop.isReference) {
            if (!prop.isMany) {
              context.addReference({element: instance, property: prop.ns.name, id: value});
            } else {
              values = value.split(' ');
              forEach(values, function (v) {
                context.addReference({element: instance, property: prop.ns.name, id: v});
              });
            }
          } else {
            if (prop) {
      ...
      ElementHandler.prototype.getPropertyForNode = function (node) {
        ...
        var propertyName = nameNs.name, property = descriptor.propertiesByName[propertyName], elementTypeName, elementType, typeAnnotation;
        if (property) {
      ...
      GenericElementHandler.prototype.createElement = function (node) {
        var name = node.name, prefix = node.prefix, uri = node.ns[prefix], attributes = node.attributes;
      ...
      XMLReader.prototype.fromXML = function (xml, options, done) {
        ...
        var context = new Context(assign({}, options, {rootHandler: rootHandler})), parser = new SaxParser(true, {xmlns: true, trim: true}), stack = new Stack();
        ...
        function resolveReferences() {
          ...
          for (i = 0; !!(r = references[i]); i++) {
            ...
            if (!reference) {
              context.addWarning({message: 'unresolved reference <' + r.id + '>', element: r.element, property: r.property, value: r.id});
            }
            if (property.isMany) {
        ...
        function handleOpen(node) {
          ...
          try {
            ...
            var line = this.line, column = this.column;
            var message = 'unparsable content <' + node.name + '> detected\n\t' + 'line: ' + line + '\n\t' + 'column: ' + column + '\n\t' + 'nested error: ' + e.message;
            if (lax) {
              context.addWarning({message: message, error: e});
      ...
      return {'XMLReader': XMLReader, 'ElementHandler': __};
    };
    wm._22 = function () {
      var sax = {};
    ...
    wm._26 = function () {
      'use strict';
      var pick = new wm._212, assign = new wm._206, forEach = new wm._92;
      ...
      DescriptorBuilder.prototype.build = function () {
        return pick(this, ['ns', 'name', 'allTypes', 'properties', 'propertiesByName', 'bodyProperty', 'idProperty']);
      };
      ...
      DescriptorBuilder.prototype.addTrait = function (t, inherited) {
        ...
        forEach(t.properties, function (p) {
          p = assign({}, p, {name: p.ns.localName, inherited: inherited});
    ...
    wm._27 = function () {
      ...
      Factory.prototype.createType = function (descriptor) {
        ...
        props.defineDescriptor(ModdleElement, descriptor); /* changes for Spread Correlation Project */
    ...
    wm._28 = function () {
      var isString = new wm._203, isObject = new wm._201, forEach = new wm._92, find = new wm._91;
      var Factory = new wm._27, Registry = new wm._31, Properties = new wm._30;
      ...
      Moddle.prototype.createAny = function (name, nsUri, properties) {
        ...
        var descriptor = {name: name, isGeneric: true, ns: {prefix: nameNs.prefix, localName: nameNs.localName, uri: nsUri}};
    ...
    wm._29 = function () {
      var parseName = function (name, defaultPrefix) {
        ...
        return {name: name, prefix: prefix, localName: localName};
      };
      return parseName;
    };
    wm._30 = function () {
      ...
      function defineProperty(target, property, value) {
        Object.defineProperty(target, property.name, {enumerable: !property.isReference, writable: true, value: value, configurable: true});
      }
      ;
      return Properties;
    };
    wm._31 = function () {
      var assign = new window.j2.mod._._206, forEach = new window.j2.mod._._92;
      var Types = new window.j2.mod._._32, DescriptorBuilder = new window.j2.mod._._26;
      var parseNameNs = new window.j2.mod._._29, isBuiltInType = Types.isBuiltIn;
      ...
      Registry.prototype.registerType = function (type, pkg) {
        type = assign({}, type, {superClass: (type.superClass || []).slice(), extends: (type.extends || []).slice(), properties: (type.properties || []).slice()});
        var ns = parseNameNs(type.name, pkg.prefix), name = ns.name, propertiesByName = {};
        forEach(type.properties, function (p) {
          var propertyNs = parseNameNs(p.name, ns.prefix), propertyName = propertyNs.name;
        ...
        assign(type, {ns: ns, name: name, propertiesByName: propertiesByName});
    ...
    wm._32 = function () {
      ...
      var TYPE_CONVERTERS = {String: function (s) {
          return s;
        }, Boolean: function (s) {
          return s === 'true';
        }, Integer: function (s) {
      ...
      return {'isSimple': isSimple, 'isBuiltIn': isBuiltIn, 'coerceType': coerceType};
    };
    wm._35 = function () {
      return {"name": "DC", "uri": "http://www.omg.org/spec/DD/20100524/DC", "types": [{"name": "Boolean"}, {"name": "Integer"}, {"name": "Real"}, {"name": "String"}, {"name": "Font", "properties": [{"name": "name", "type": "String", "isAttr": true}, {"name": "size", "type": "Real", "isAttr": true}, {"name": "isBold", "type": "Boolean", "isAttr": true}, {"name": "isItalic", "type": "Boolean", "isAttr": true}, {"name": "isUnderline", "type": "Boolean", "isAttr": true}, {"name": "isStrikeThrough", "type": "Boolean", "isAttr": true}]}, {"name": "Point", "properties": [{"name": "x", "type": "Real", "default": "0", "isAttr": true}, {"name": "y", "type": "Real", "default": "0", "isAttr": true}]}, {"name": "Bounds", "properties": [{"name": "x", "type": "Real", "default": "0", "isAttr": true}, {"name": "y", "type": "Real", "default": "0", "isAttr": true}, {"name": "width", "type": "Real", "isAttr": true}, {"name": "height", "type": "Real", "isAttr": true}]}], "prefix": "dc", "associations": []};
    };
    wm._j2SchemaXML = function () {
      return {"name": "j2", "uri": "http://j2", "types": [{"name": "classe", "superClass": ["orderedElement"], "properties": [/*  {                "name": "classes",                "isMany": true,                "type": "orderedElement"             },*/             {"name": "constructs", "isMany": true, "type": "constructs"}, {"name": "id", "isAttr": true, "type": "String"}, {"name": "versao", "isAttr": true, "type": "String"}]}, {"name": "classeDef", "superClass": ["modelo"], "properties": [/*{                "name": "id",                "isAttr": true,                "type": "String"             },                      {                "name": "versao",                "isMany": true,                "type": "versao"             }*/]}, {'name': 'config', 'properties': [{'name': 'dadosServidoresLocal', 'isMany': false, 'type': 'dadosServidoresLocal'}, {'name': 'globalStyle', 'isMany': false, 'type': 'globalStyle'}, {'name': 'servidorLocal', 'isMany': false, 'type': 'servidorLocal'}]}, {"name": "constructs", "properties": [{"name": "param", "isAttr": true, "type": "String"}, {"name": "type", "isAttr": true, "type": "String"}, {"name": "value", "isAttr": true, "type": "String"}]}, {"name": "dadosServidoresLocal", "properties": [{"name": "avaliable", "isAttr": true, "type": "Boolean"}, {"name": "j2Xml", "isMany": false, "type": "j2Xml"}]}, {"name": "Definitions", "properties": [{"name": "classeDefs", "isMany": true, "type": "classeDef"}, {"name": "id", "isAttr": true, "type": "String"}, {"name": "modelos", "isMany": true, "type": "modelo"}, {"name": "unidades", "isMany": true, "type": "Unidade"}, {"name": "usuarios", "isMany": true, "type": "Usuarios"}]}, {"name": "element", "superClass": ["orderedElement"], "properties": [{"name": "class", "isAttr": true, "type": "String"}, {"name": "id", "isAttr": true, "type": "String"}, {"name": "HTMLAttribute", "isMany": true, "type": "HTMLAttribute"}, /*             {               "name": "modelos",               "isMany": true,               "type": "modelo"             }      */                        {"name": "tag", "isAttr": true, "type": "String"}, {"name": "text", "isBody": true, "type": "String"}]}, {"name": "globalStyle", "properties": [/*{               "name": "dobBinId",               "isAttr": true,               "type": "Integer"            },                       {               "name": "assuntoId",               "isAttr": true,               "type": "String"            },                      {               "name": "libId",               "isAttr": true,               "type": "String"            }     */]}, {"name": "HTMLAttribute", "properties": [{"name": "name", "isAttr": true, "type": "String"}, {"name": "value", "isAttr": true, "type": "String"}]}, {"name": "innerContent", "superClass": ["orderedElement"]}, {"name": "j2Xml", "properties": [{"name": "dobBinId", "isAttr": true, "type": "Integer"}, {"name": "assuntoId", "isAttr": true, "type": "String"}, {"name": "libId", "isAttr": true, "type": "String"}]}, {"name": "modelo", "properties": [{"name": "versao", "isMany": true, "type": "versao"}, {"name": "id", "isAttr": true, "type": "String"}]}, {"name": "modeloAut", "properties": [{"name": "id", "isAttr": true, "type": "String"}, {"name": "version", "isAttr": true, "type": "String"}]}, {"name": "modelosAut", "properties": [{"name": "modeloAut", "isMany": true, "type": "modeloAut"}]}, {"name": "orderedElement", "properties": [{'name': 'configPart', 'isMany': true, 'type': 'orderedElement'}]}, {"name": "Unidade", "properties": [{"name": "config", "isMany": false, "type": "config"}, {"name": "id", "isAttr": true, "type": "String"}, {"name": "modelosAut", "isMany": false, "type": "modelosAut"}]}, {"name": "servidorLocal", "properties": [{"name": "avaliable", "isAttr": true, "type": "Boolean"}, {"name": "domain", "isAttr": true, "type": "String"}]}, {"name": "textHTML", "superClass": ["orderedElement"], "properties": [{"name": "text", "isBody": true, "type": "String"}]}, {"name": "Usuario", "properties": [{"name": "id", "isAttr": true, "type": "String"}, {"name": "ini", "isAttr": true, "type": "String"}, {"name": "nome", "isAttr": true, "type": "String"}, {"name": "cargo", "isAttr": true, "type": "String"}]}, {"name": "Usuarios", "properties": [{"name": "versao", "isAttr": true, "type": "String"}, {"name": "usuario", "isMany": true, "type": "Usuario"}]}, {"name": "versao", "superClass": ["orderedElement"], "properties": [/*{              "name": "configPart",              "isMany": true,              "type": "orderedElement"            },/*            {              "name": "element",              "isMany": true,              "type": "element"            },    */                   {"name": "id", "isAttr": true, "type": "String"}]}], "emumerations": [], "associations": [], "prefix": "j2"};
    };
    wm._j2ModdleConstructor = function () {
      var assign = new wm._206;
      var j2Moddle = new wm._j2Moddle;
      var packages = {dc: new wm._35, j2: new wm._j2SchemaXML};
    ...
    wm._j2Moddle = function () {
      var isString = new wm._203, isFunction = new wm._198, assign = new wm._206;
      var Moddle = new window.j2.mod._._24, XmlReader = new window.j2.mod._._20;
